...
public:
	...
	// void OnExitGateOpened(FGameplayTag gameEventType, FGameEventData& GameEventData);                                     // [0x52240a0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnFinishedPlaying(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x52243d0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnEscapeChase(FGameplayTag gameEventType, FGameEventData& GameEventData);                                        // [0x52241b0] Final|Native|Public|HasOutParms 
	// Function /Script/Archives.ChaseInBasementQEEvaluator.OnChaseStart
	// void OnChaseStart(FGameplayTag gameEventType, FGameEventData& GameEventData);                                         // [0x5223f90] Final|Native|Public|HasOutParms 
	// Function /Script/Archives.ChaseInBasementQEEvaluator.OnChaseEnd
	// void OnChaseEnd(FGameplayTag gameEventType, FGameEventData& GameEventData);                                           // [0x5223e80] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// bool PlayerHasToCompleteAssociatedQuest(class ADBDPlayer* Player, FName SpecialBehaviourId);                          // [0x5224ff0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Archives.ContextualQuestUtilities.PlayerHasAssociatedQuest
	// bool PlayerHasAssociatedQuest(class ADBDPlayer* Player, FName SpecialBehaviourId);                                    // [0x5224f10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void OnEscaped(FGameplayTag gameEventType, FGameEventData& GameEventData);                                            // [0x52242c0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnHooked(FGameplayTag gameEventType, FGameEventData& GameEventData);                                             // [0x5224700] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnEndGameCollapseStart(FGameplayTag gameEventType, FGameEventData& GameEventData);                               // [0x52240a0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnFinishedPlaying(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x52244e0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnFinishedPlaying(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x52245f0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnTargetEscapeFromTrial(FGameplayTag gameEventType, FGameEventData& GameEventData);                              // [0x5224e00] Final|Native|Public|HasOutParms 
	// Function /Script/Archives.EscapeBasementItemQEEvaluator.OnItemCollectedFromChest
	// void OnItemCollectedFromChest(FGameplayTag gameEventType, FGameEventData& GameEventData);                             // [0x5224a80] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnSurvivorRemoved(class ACamperPlayer* removedPlayer);                                                           // [0x5224d70] Final|Native|Private|Const 
	// Function /Script/Archives.ExtendItemChargesQEEvaluator.OnItemRemoved
	// void OnItemRemoved(class ACollectable* removedItem, EInventoryType inventoryType, class ADBDPlayer* Player);          // [0x5224c20] Final|Native|Private|Const 
	// Function /Script/Archives.ExtendItemChargesQEEvaluator.OnItemEmpty
	// void OnItemEmpty(class ADBDPlayer* itemUser);                                                                         // [0x5224b90] Final|Native|Private 
	// Function /Script/Archives.ExtendItemChargesQEEvaluator.OnItemChargeChanged
	// void OnItemChargeChanged(float previousCharge, float currentCharge, class ADBDPlayer* itemUser, class ACollectable* Item); // [0x5224920] Final|Native|Private 
	// Function /Script/Archives.ExtendItemChargesQEEvaluator.OnItemAdded
	// void OnItemAdded(class ACollectable* addedItem, EInventoryType inventoryType, class ADBDPlayer* Player);              // [0x5224810] Final|Native|Private 
};
...
public:
	...
	// void OnRep_Repaired();                                                                                                // [0x5224d50] Final|Native|Private|Const 
	// Function /Script/Archives.FragileObjectComponent.OnFragileObjectStateChanged__DelegateSignature
	// void OnFragileObjectStateChanged__DelegateSignature();                                                                // [0x66265f0] MulticastDelegate|Public|Delegate 
	// Function /Script/Archives.FragileObjectComponent.IsRepaired
	// bool IsRepaired();                                                                                                    // [0x5223e50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Archives.FragileObjectComponent.GetPreviousCollector
	// class ADBDPlayer* GetPreviousCollector();                                                                             // [0x5223d80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Archives.FragileObjectComponent.DBD_RepairFragileObject
	// void DBD_RepairFragileObject();                                                                                       // [0x46bf300] Final|Exec|Native|Private 
	// Function /Script/Archives.FragileObjectComponent.Authority_OnCamperRemoved
	// void Authority_OnCamperRemoved(class ACamperPlayer* removedPlayer);                                                   // [0x5223b40] Final|Native|Private 
};
...
public:
	...
	// void OnRep_PlayersWithVisibility();                                                                                   // [0x5224d30] Final|Native|Protected 
	// Function /Script/Archives.Glyph.IsPlayerOwner
	// bool IsPlayerOwner(class ADBDPlayer* Player);                                                                         // [0x5223db0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Archives.Glyph.DoesLocalPlayerHaveVisibility
	// bool DoesLocalPlayerHaveVisibility();                                                                                 // [0x5223d50] Final|Native|Protected|BlueprintCallable|BlueprintPure 
	// Function /Script/Archives.Glyph.Cosmetic_OnStoppedInteracting
	// void Cosmetic_OnStoppedInteracting();                                                                                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Archives.Glyph.Cosmetic_OnStartedInteracting
	// void Cosmetic_OnStartedInteracting(class ADBDPlayer* interactingPlayer, float interactionDuration);                   // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Archives.Glyph.Cosmetic_OnInteractionCompleted
	// void Cosmetic_OnInteractionCompleted(class ADBDPlayer* interactingPlayer);                                            // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Archives.Glyph.Cosmetic_OnGlyphVisibilityChanged
	// void Cosmetic_OnGlyphVisibilityChanged(class ADBDPlayer* interactingPlayer, bool IsVisible);                          // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Archives.Glyph.Authority_TrackPlayerWithBehaviourID
	// void Authority_TrackPlayerWithBehaviourID(class ADBDPlayer* DBDPlayer);                                               // [0x5223cc0] Final|Native|Private 
	// Function /Script/Archives.Glyph.Authority_OnPlayerBreachedRangeThreshold
	// void Authority_OnPlayerBreachedRangeThreshold(bool isWithinRange, class AActor* trackedActor);                        // [0x5223bf0] Final|Native|Private 
	// Function /Script/Archives.Glyph.Authority_OnIntroCompleted
	// void Authority_OnIntroCompleted();                                                                                    // [0x5223bd0] Final|Native|Private 
	// Function /Script/Archives.Glyph.Authority_OnInteractionCompleted
	// void Authority_OnInteractionCompleted(class ADBDPlayer* interactingPlayer);                                           // [0x66265f0] BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void DBD_ShowAuraGreenGlyphsActive(bool Enabled);                                                                     // [0x522aea0] Final|Exec|Native|Private 
	// Function /Script/Archives.GreenGlyphActivatorComponent.Authority_OnActivateGlyphEvents
	// void Authority_OnActivateGlyphEvents(FGameplayTag GameplayTag, FGameEventData& GameEventData);                        // [0x522ad90] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.GreenGlyphActivatorComponent.Authority_EndGameScenarioBegins
	// void Authority_EndGameScenarioBegins(FGameplayTag GameplayTag, FGameEventData& GameEventData);                        // [0x522ac80] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnRep_SetShouldOutlineBeActive();                                                                                // [0x522b7b0] Final|Native|Private 
	// Function /Script/Archives.GreenGlyphComponent.Multicast_Cheat_ShowAuraGreenGlyphActive
	// void Multicast_Cheat_ShowAuraGreenGlyphActive(bool Enabled, bool bForceShowAura);                                     // [0x522af30] Net|NetReliableNative|Event|NetMulticast|Public 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x522b790] Final|Native|Private 
	// Function /Script/Archives.HasInteractedMapTrackedInteractorQEEvaluator.OnActorTrackedByMap
	// void OnActorTrackedByMap(class UActorKnowledgeCollection* knowledgeCollection, class AActor* newActor);               // [0x522b010] Final|Native|Private 
};
...
public:
	...
	// void OnRangeChanged(bool inRange);                                                                                    // [0x5230400] Final|Native|Protected 
};
...
public:
	...
	// void OnSlashHarpoonedCamper(FGameplayTag gameEventType, FGameEventData& GameEventData);                               // [0x522b7d0] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.HideNearKillerQEEvaluator.OnHarpoonHit
	// void OnHarpoonHit(FGameplayTag gameEventType, FGameEventData& GameEventData);                                         // [0x522b680] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.HideNearKillerQEEvaluator.OnFinishedPlaying
	// void OnFinishedPlaying(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x522b570] Final|Native|Public|HasOutParms 
	// Function /Script/Archives.HideNearKillerQEEvaluator.OnChaseStart
	// void OnChaseStart(class ADBDPlayer* chasedSurvivor);                                                                  // [0x522b2c0] Final|Native|Private 
	// Function /Script/Archives.HideNearKillerQEEvaluator.OnChaseEnd
	// void OnChaseEnd(class ADBDPlayer* chasedSurvivor, float chaseTime);                                                   // [0x522b1f0] Final|Native|Private 
	// Function /Script/Archives.HideNearKillerQEEvaluator.OnCamperBreakFreeFromHarpoon
	// void OnCamperBreakFreeFromHarpoon(FGameplayTag gameEventType, FGameEventData& GameEventData);                         // [0x522b0e0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnStopEventCount(FGameplayTag gameEventType, FGameEventData& GameEventData);                                     // [0x5230510] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.MaxEventCountQEEvaluator.OnIncrementEventCount
	// void OnIncrementEventCount(FGameplayTag gameEventType, FGameEventData& GameEventData);                                // [0x52300b0] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.MaxEventCountQEEvaluator.OnDecrementEventCount
	// void OnDecrementEventCount(FGameplayTag gameEventType, FGameEventData& GameEventData);                                // [0x522ffa0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnSurvivorUnhooked(FGameplayTag gameEventType, FGameEventData& GameEventData);                                   // [0x5235bd0] Native|Protected|HasOutParms 
	// Function /Script/Archives.SurvivorHookSameTimeQEEvaluator.OnSurvivorHooked
	// void OnSurvivorHooked(FGameplayTag gameEventType, FGameEventData& GameEventData);                                     // [0x5235ac0] Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnClosetHideExit(FGameplayTag gameEventType, FGameEventData& GameEventData);                                     // [0x522b460] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.InLockerNearKillerQEEvaluator.OnClosetHideEnter
	// void OnClosetHideEnter(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x522b350] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnItemConsumed(FGameplayTag gameEventType, FGameEventData& GameEventData);                                       // [0x52301c0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnItemUsed(FGameplayTag gameEventType, FGameEventData& GameEventData);                                           // [0x52302d0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnSurvivorRemoved(class ACamperPlayer* survivorRemoved);                                                         // [0x52306b0] Final|Native|Private 
	// Function /Script/Archives.LivingSurvivorsCountQEEvaluator.OnSurvivorAdded
	// void OnSurvivorAdded(class ACamperPlayer* survivorAdded);                                                             // [0x5230620] Final|Native|Private 
};
...
public:
	...
	// void StopTrackingActor(class AActor* Actor);                                                                          // [0x5230850] Final|Native|Public|BlueprintCallable 
	// Function /Script/Archives.NearTrackedActorComponent.StartTrackingActor
	// void StartTrackingActor(class AActor* Actor);                                                                         // [0x52307c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Archives.NearTrackedActorComponent.SetDistanceThreshold
	// void SetDistanceThreshold(float value);                                                                               // [0x5230740] Final|Native|Public|BlueprintCallable 
	// Function /Script/Archives.NearTrackedActorComponent.OnIsWithinRangeChanged__DelegateSignature
	// void OnIsWithinRangeChanged__DelegateSignature(bool isWithinRange, class AActor* trackedActor);                       // [0x66265f0] MulticastDelegate|Public|Delegate 
	// Function /Script/Archives.NearTrackedActorComponent.IsActorWithinRange
	// bool IsActorWithinRange(class AActor* Actor);                                                                         // [0x522fdf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Cosmetic_ApplyNegativeEffects(class ADBDPlayer* affectedPlayer);                                                 // [0x522fd00] Final|BlueprintCosmetic|Native|Private 
};
...
public:
	...
	// void OnRep_MarkedProgress();                                                                                          // [0x52304f0] Final|Native|Private 
	// Function /Script/Archives.PinkGlyphComponent.OnRep_IsPinkGlyphActive
	// void OnRep_IsPinkGlyphActive();                                                                                       // [0x52304d0] Final|Native|Private|Const 
	// Function /Script/Archives.PinkGlyphComponent.OnRep_IsMarking
	// void OnRep_IsMarking();                                                                                               // [0x52304b0] Final|Native|Private|Const 
	// Function /Script/Archives.PinkGlyphComponent.OnRep_HasLineOfSightToSurvivor
	// void OnRep_HasLineOfSightToSurvivor();                                                                                // [0x5230490] Final|Native|Private|Const 
	// Function /Script/Archives.PinkGlyphComponent.OnMarkProgressChanged__DelegateSignature
	// void OnMarkProgressChanged__DelegateSignature(float progress);                                                        // [0x66265f0] MulticastDelegate|Public|Delegate 
	// Function /Script/Archives.PinkGlyphComponent.OnGlyphEvent__DelegateSignature
	// void OnGlyphEvent__DelegateSignature();                                                                               // [0x66265f0] MulticastDelegate|Public|Delegate 
	// Function /Script/Archives.PinkGlyphComponent.Multicast_TeleportGlyph
	// void Multicast_TeleportGlyph(FVector Location);                                                                       // [0x522ff20] Net|NetReliableNative|Event|NetMulticast|Protected|HasDefaults 
	// Function /Script/Archives.PinkGlyphComponent.Multicast_StartGlyphPreTeleport
	// void Multicast_StartGlyphPreTeleport();                                                                               // [0x522ff00] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/Archives.PinkGlyphComponent.Multicast_IsFullyMarkedSurvivor
	// void Multicast_IsFullyMarkedSurvivor();                                                                               // [0x522fee0] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/Archives.PinkGlyphComponent.Multicast_EnterGlyphRange
	// void Multicast_EnterGlyphRange();                                                                                     // [0x522fec0] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/Archives.PinkGlyphComponent.IsMarking
	// bool IsMarking();                                                                                                     // [0x522fe90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Archives.PinkGlyphComponent.Authority_TeleportGlyph
	// void Authority_TeleportGlyph();                                                                                       // [0x522fce0] Final|Native|Private 
	// Function /Script/Archives.PinkGlyphComponent.Authority_OnSurvivorInMovementRangeChanged
	// void Authority_OnSurvivorInMovementRangeChanged(bool inRange);                                                        // [0x522fbc0] Final|Native|Private 
	// Function /Script/Archives.PinkGlyphComponent.Authority_OnPlayerBreachedRangeThreshold
	// void Authority_OnPlayerBreachedRangeThreshold(bool isWithinRange, class AActor* trackedActor);                        // [0x522faf0] Final|Native|Private 
	// Function /Script/Archives.PinkGlyphComponent.Authority_OnLevelReadyToPlay
	// void Authority_OnLevelReadyToPlay();                                                                                  // [0x522fad0] Final|Native|Private 
	// Function /Script/Archives.PinkGlyphComponent.Authority_OnDamageStateChanged
	// void Authority_OnDamageStateChanged(ECamperDamageState oldDamageState, ECamperDamageState newDamageState);            // [0x522fa00] Final|Native|Private 
};
...
public:
	...
	// void StopGlyphMovement(bool useDeceleration);                                                                         // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/Archives.PurpleGlyphComponent.StartGlyphMovement
	// void StartGlyphMovement();                                                                                            // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/Archives.PurpleGlyphComponent.ResumeGlyphMovement
	// void ResumeGlyphMovement(bool useAcceleration);                                                                       // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/Archives.PurpleGlyphComponent.OnLevelReadyToPlay
	// void OnLevelReadyToPlay();                                                                                            // [0x52303e0] Final|Native|Private 
	// Function /Script/Archives.PurpleGlyphComponent.GetTrackedPlayer
	// class ADBDPlayer* GetTrackedPlayer();                                                                                 // [0x522fdc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Archives.PurpleGlyphComponent.GetOwningGlyph
	// class AGlyph* GetOwningGlyph();                                                                                       // [0x522fd90] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Archives.PurpleGlyphComponent.Authority_StartMoveWithAcceleration
	// void Authority_StartMoveWithAcceleration(FVector& goalLocation);                                                      // [0x522fc50] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Archives.PurpleGlyphComponent.Authority_MoveTo
	// void Authority_MoveTo(FVector Location);                                                                              // [0x522f970] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Archives.PurpleGlyphComponent.Authority_GetNextLocation
	// FVector Authority_GetNextLocation();                                                                                  // [0x522f930] Final|Native|Private|HasDefaults|BlueprintCallable 
	// Function /Script/Archives.PurpleGlyphComponent.Authority_AbortMoveWithDeceleration
	// void Authority_AbortMoveWithDeceleration();                                                                           // [0x522f910] Final|Native|Public|BlueprintCallable 
	// Function /Script/Archives.PurpleGlyphComponent.Authority_AbortMove
	// void Authority_AbortMove();                                                                                           // [0x522f8f0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnPlayerGameStateChanged(class ADBDPlayerState* PlayerState, EGameState GameState);                              // [0x52359f0] Final|Native|Private 
	// Function /Script/Archives.QuestEventsHandler.OnGameEnded
	// void OnGameEnded(EEndGameReason Reason);                                                                              // [0x5235840] Final|Native|Private 
	// Function /Script/Archives.QuestEventsHandler.OnFinishedPlaying
	// void OnFinishedPlaying(FGameplayTag gameEventType, FGameEventData& GameEventData);                                    // [0x5235730] Final|Native|Private|HasOutParms 
	// Function /Script/Archives.QuestEventsHandler.DBD_ShowInGameCurrentQuestInfos
	// void DBD_ShowInGameCurrentQuestInfos();                                                                               // [0x5235600] Final|Exec|Native|Public 
	// Function /Script/Archives.QuestEventsHandler.DBD_InGameAddProgressionToCurrentQuest
	// void DBD_InGameAddProgressionToCurrentQuest(int32_t Amount);                                                          // [0x5235570] Final|Exec|Native|Public 
};
...
public:
	...
	// void InitializeQuestEventHandler(class UQuestEventsHandler* QuestEventsHandler);                                      // [0x5235620] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnItemSpawnedFromChest(FGameplayTag gameEventType, FGameEventData& GameEventData);                               // [0x52358c0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnReadyForInteractionDelegate__DelegateSignature();                                                              // [0x66265f0] MulticastDelegate|Public|Delegate 
...
public:
	...
	// void Authority_OnLevelReadyToPlay();                                                                                  // [0x52354b0] Final|Native|Private 
};
...
public:
	...
	// void Multicast_TeleportGlyph(FVector Location);                                                                       // [0x52356a0] Net|NetReliableNative|Event|NetMulticast|Protected|HasDefaults 
...
public:
	...
	// void StartGlyphPreTeleportVFX();                                                                                      // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/Archives.YellowGlyphComponent.StartGlyphPostTeleportVFX
	// void StartGlyphPostTeleportVFX();                                                                                     // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/Archives.YellowGlyphComponent.OnLevelReadyToPlay
	// void OnLevelReadyToPlay();                                                                                            // [0x52359d0] Final|Native|Private 
	...
	// bool Authority_TeleportGlyph(int32_t maxNumberOfTries);                                                               // [0x52354d0] Final|Native|Protected|BlueprintCallable 
};
