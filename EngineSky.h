...
public:
	...
	// void RefreshMaterial();                                                                                               // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Engine/EngineSky/BP_Sky_Sphere.BP_Sky_Sphere_C.UpdateSunDirection
	// void UpdateSunDirection();                                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Engine/EngineSky/BP_Sky_Sphere.BP_Sky_Sphere_C.UserConstructionScript
	// void UserConstructionScript();                                                                                        // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
};
