...
public:
	...
	// class ALocker* GetLocker();                                                                                           // [0x54eda30] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetAntiCampTrapImmunityDuration();                                                                              // [0x54ed8e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UStalkerComponent* GetStalkerComponent();                                                                       // [0x54edaf0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.BaseStalkModeInteraction.CanStalk
	// bool CanStalk();                                                                                                      // [0x54ed790] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class ATotem* GetTotem();                                                                                             // [0x54edb50] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_SpawnedChargeable();                                                                                       // [0x54edec0] Final|Native|Private 
};
...
public:
	...
	// void Cosmetic_OnInteractionStarted();                                                                                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/DBDInteraction.BlessTotem.Cosmetic_OnInteractionFinished
	// void Cosmetic_OnInteractionFinished();                                                                                // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class ACollectable* GetItem();                                                                                        // [0x54eda30] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void CustomizePropertiesForBlight(class ADBDPlayer* killer);                                                          // [0x66265f0] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class ACollectable* GetItem();                                                                                        // [0x54eda60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetIsObstructed(bool obstructed);                                                                                // [0x54edee0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.IsObstructed
	// bool IsObstructed();                                                                                                  // [0x54eddd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.IsInteractionPossibleInternal
	// bool IsInteractionPossibleInternal(class ADBDPlayer* Player);                                                         // [0x54edd30] Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.IsBeingRepaired
	// bool IsBeingRepaired();                                                                                               // [0x54edd00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.GetOwningGenerator
	// class AGenerator* GetOwningGenerator();                                                                               // [0x54edac0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.GetInteractionChargeSpeedMultiplier_Implementation
	// float GetInteractionChargeSpeedMultiplier_Implementation(class ADBDPlayer* Character);                                // [0x54ed910] Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorRepairInteraction.Authority_OnSkillCheckResponseAuthority
	// void Authority_OnSkillCheckResponseAuthority(bool success, bool Bonus, class ADBDPlayer* Player, bool TriggerLoudNoise, ESkillCheckCustomType Type); // [0x54ed5d0] Final|Native|Private 
};
...
public:
	...
	// bool HasChargedToolBox(class ADBDPlayer* Player);                                                                     // [0x54edbe0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.GeneratorToolboxRepairInteraction.GetInteractionTextWhenEmpty
	// FString GetInteractionTextWhenEmpty();                                                                                // [0x54ed9b0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void DispatchStunEvent(class ADBDPlayer* Player);                                                                     // [0x54ed7c0] Native|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class ACamperPlayer* GetTargetSurvivor();                                                                             // [0x54edb20] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.HealInteraction.Authority_OnChargeApplied
	// void Authority_OnChargeApplied(float individualChargeAmount, float totalChargeAmount, class AActor* chargeInstigator, bool wasCoop, float DeltaTime); // [0x66265f0] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class AMeatHook* GetMeatHook();                                                                                       // [0x54eda90] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Multicast_OnTriggerSkillCheck(class ADBDPlayer* Player);                                                         // [0x54ede30] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
...
public:
	...
	// bool IsVomiting();                                                                                                    // [0x54ede00] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDInteraction.LinkedVomitInteraction.GetVomitStateComponent
	// class UVomitStateComponent* GetVomitStateComponent();                                                                 // [0x54edb80] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void FireChestScoreEvent(class ADBDPlayer* Player);                                                                   // [0x54ed850] Final|Native|Private|BlueprintCallable 
};
...
public:
	...
	// void InitThrowCancellationExitTime(float value);                                                                      // [0x54edc80] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDInteraction.ThrowInteraction.HasCancelledThrow
	// bool HasCancelledThrow();                                                                                             // [0x54edbb0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Multicast_SetPlayerBeingUnhooked(class UUnhook* unhookInteraction, class ACamperPlayer* playerBeingUnhooked);    // [0x51ddf80] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
