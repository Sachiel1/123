...
public:
	...
	// bool CheckPermission(FString permission);                                                                             // [0x514b410] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                              // [0x514b340] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
