...
public:
	...
	// void OnScoreTypeEvent(EDBDScoreTypes scoreType, float Amount, class AActor* Instigator, class AActor* Target);        // [0x51c8db0] Native|Protected     
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x51c8d90] Final|Native|Public  
	// Function /Script/Achievements.SurvivorRevealedKillerAuraAchievement.Local_OnRevealKillerAura
	// void Local_OnRevealKillerAura();                                                                                      // [0x51c8d70] Final|Native|Public  
};
