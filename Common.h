...
public:
	...
	// void Destruct();                                                                                                      // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	...
	// void SetCustomizationRewardData(FCustomizationRewardViewData& CustomizationRewardViewData);                           // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void PreConstruct(bool IsDesignTime);                                                                                 // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreCustomizationReward(int32_t EntryPoint);                                                // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void SetCharacterRewardData(FCharacterRewardViewData& CharacterRewardViewData);                                       // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreCharacterReward(int32_t EntryPoint);                                                    // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(16,3541) /* FMulticastInlineDelegate */ __um(RewardAnimtionDone);                                // 0x02D8   (0x0010)  
	...
	// void Finished_705593924B773F37BEBD89BEA8077861();                                                                     // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void Finished_B8DBF1554B4482E8F46849B162C58243();                                                                     // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Rewards/WBP_CoreRewardWrapperAnimation.WBP_CoreRewardWrapperAnimation_C.PlayTextFadeOutAnim
	// void PlayTextFadeOutAnim(float Delay);                                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Rewards/WBP_CoreRewardWrapperAnimation.WBP_CoreRewardWrapperAnimation_C.OnSetSmallTemplate
	// void OnSetSmallTemplate(bool bIsSmall);                                                                               // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void PlayClaimedAnim(float TimeOnTextFadeOut);                                                                        // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreRewardWrapperAnimation(int32_t EntryPoint);                                             // [0x66265f0] Final                
	...
	// void RewardAnimtionDone__DelegateSignature();                                                                         // [0x66265f0] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetWidgetSize(ERewardType ItemType);                                                                             // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Rewards/WBP_CoreRewardWrapper.WBP_CoreRewardWrapper_C.SetPreviewWidget
	// void SetPreviewWidget(ERewardType RewardType);                                                                        // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreRewardWrapper(int32_t EntryPoint);                                                      // [0x66265f0] Final                
};
...
public:
	...
	SDK_UNDEFINED(80,3542) /* TMap<EControlMode, UDataTable*> */ __um(ControlModeDataMap);                         // 0x03A8   (0x0050)  
	...
	SDK_UNDEFINED(1,3543) /* TEnumAsByte<EHorizontalAlignment> */ __um(PaddingAlignment);                          // 0x0408   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0409   (0x0003)  MISSED
	float                                              PaddingValue;                                               // 0x040C   (0x0004)  
	SDK_UNDEFINED(16,3544) /* TArray<TWeakObjectPtr<UTexture2D*>> */ __um(WideIcons);                              // 0x0410   (0x0010)  


	/// Functions
	// Function /DBDUICore/Common/Inputs/InputPrompts/WBP_CoreInputPrompt.WBP_CoreInputPrompt_C.HandlePromptDataRow
	// void HandlePromptDataRow(FInputPromptDataRow& PromptDataRow);                                                         // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/InputPrompts/WBP_CoreInputPrompt.WBP_CoreInputPrompt_C.HandleUnfoundPrompt
	// void HandleUnfoundPrompt();                                                                                           // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/InputPrompts/WBP_CoreInputPrompt.WBP_CoreInputPrompt_C.GetDataTable
	// void GetDataTable(class UDataTable*& DataTable, bool& IsFound);                                                       // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/InputPrompts/WBP_CoreInputPrompt.WBP_CoreInputPrompt_C.SetIconTexture
	// void SetIconTexture(TWeakObjectPtr<UTexture2D*>& iconTexture);                                                        // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Construct();                                                                                                     // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreInputPrompt(int32_t EntryPoint);                                                        // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(16,3545) /* FString */               __um(ActionMapping);                                        // 0x04B0   (0x0010)  
	...
	// void ExecuteUbergraph_WBP_CoreBackButton(int32_t EntryPoint);                                                         // [0x66265f0] Final                
};
...
public:
	...
	SDK_UNDEFINED(48,3546) /* TWeakObjectPtr<UTexture2D*> */ __um(iconTexture);                                    // 0x0520   (0x0030)  
	...
	// void ShowSubPanel(bool IsHovered);                                                                                    // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/Buttons/WBP_CoreFooterButton.WBP_CoreFooterButton_C.UpdateInteractability
	// void UpdateInteractability();                                                                                         // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/Buttons/WBP_CoreFooterButton.WBP_CoreFooterButton_C.UpdateDisableVisuals
	// void UpdateDisableVisuals();                                                                                          // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetButtonDisableState(EButtonDisableState buttonDisableState);                                                   // [0x66265f0] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreFooterButton(int32_t EntryPoint);                                                       // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void SetCurrencyProgressionRewardData(FCurrencyProgressionRewardViewData& CurrencyProgressionRewardViewData);         // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreCurrencyProgressionReward(int32_t EntryPoint);                                          // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(48,3547) /* TWeakObjectPtr<UTexture2D*> */ __um(BadgeTexture);                                   // 0x0348   (0x0030)  
	ECustomizationCategory                             category;                                                   // 0x0378   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0379   (0x0007)  MISSED
	SDK_UNDEFINED(48,3548) /* TWeakObjectPtr<UTexture2D*> */ __um(bannerTexture);                                  // 0x0380   (0x0030)  


	/// Functions
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.SetAnimation
	// void SetAnimation(class UClass* WidgetAnimation, class UUserWidget*& WidgetObj);                                      // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.SetIcon
	// void SetIcon(TWeakObjectPtr<UTexture2D*> Texture2D);                                                                  // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__WBP_CorePlayerCardContainer_HitzoneButton_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(); // [0x66265f0] BlueprintEvent       
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.InitIcon
	// void InitIcon(TWeakObjectPtr<UTexture2D*> Icon);                                                                      // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.InitAnimation
	// void InitAnimation(class UClass* WidgetAnimation);                                                                    // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.SetOpacity
	// void SetOpacity(float Opacity);                                                                                       // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerCard/WBP_CorePlayerCardContainer.WBP_CorePlayerCardContainer_C.SetAnimationPlay
	// void SetAnimationPlay(bool IsPlaying);                                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CorePlayerCardContainer(int32_t EntryPoint);                                                // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_WBP_CoreStandardButton(int32_t EntryPoint);                                                     // [0x66265f0] Final                
};
...
public:
	...
	// void HoverVisuals(bool IsHovered);                                                                                    // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Event Update Icon Texture(TWeakObjectPtr<UTexture2D*> New Texture);                                              // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Inputs/Buttons/WBP_CoreIconButton.WBP_CoreIconButton_C.ExecuteUbergraph_WBP_CoreIconButton
	// void ExecuteUbergraph_WBP_CoreIconButton(int32_t EntryPoint);                                                         // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void SetData(FTimerFlagViewData& Data);                                                                               // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreTimerFlag.WBP_CoreTimerFlag_C.ExecuteUbergraph_WBP_CoreTimerFlag
	// void ExecuteUbergraph_WBP_CoreTimerFlag(int32_t EntryPoint);                                                          // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void SetMaterial(bool useAnimation);                                                                                  // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Overlays/WBP_LockedOverlay.WBP_LockedOverlay_C.Finished_CAC253D64C47EC4CC34AE7898425099E
	// void Finished_CAC253D64C47EC4CC34AE7898425099E();                                                                     // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_LockedOverlay(int32_t EntryPoint);                                                          // [0x66265f0] Final                
};
...
public:
	...
	// void SetPriceTagVisual();                                                                                             // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Currency/WBP_CorePriceTag.WBP_CorePriceTag_C.SetEnabled
	// void SetEnabled(bool Enabled);                                                                                        // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CorePriceTag(int32_t EntryPoint);                                                           // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(16,3551) /* FString */               __um(PreviewWidth);                                         // 0x0348   (0x0010)  
	SDK_UNDEFINED(16,3552) /* FString */               __um(PreviewHeight);                                        // 0x0358   (0x0010)  
	...
	// void ForceBorderSize(int32_t Thickness, FVector2D DesiredSize);                                                       // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.AnimationCompleted
	// void AnimationCompleted();                                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.PrintPreviewRatios
	// void PrintPreviewRatios();                                                                                            // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.UpdateMaterialColors
	// void UpdateMaterialColors(FLinearColor progressBarColor, FLinearColor BackgroundColor);                               // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnHovered(class UCoreButtonWidget* buttonTarget);                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.OnUnhovered
	// void OnUnhovered(class UCoreButtonWidget* buttonTarget);                                                              // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.OnPressed
	// void OnPressed(class UCoreButtonWidget* buttonTarget);                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.OnClicked
	// void OnClicked(class UCoreButtonWidget* buttonTarget);                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void OnReleased(class UCoreButtonWidget* buttonTarget);                                                               // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void UpdateColors(FLinearColor& progressBarColor, FLinearColor& BackgroundColor);                                     // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void EndOfAnimationEvent(class UUITweenInstance* tween);                                                              // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/Borders/WBP_CoreOnHoverBorder.WBP_CoreOnHoverBorder_C.ExecuteUbergraph_WBP_CoreOnHoverBorder
	// void ExecuteUbergraph_WBP_CoreOnHoverBorder(int32_t EntryPoint);                                                      // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_WBP_CoreSortButtonWidget(int32_t EntryPoint);                                                   // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_WBP_CoreSearchBarButton(int32_t EntryPoint);                                                    // [0x66265f0] Final                
};
...
public:
	...
	// void SetItemPreviewContainer();                                                                                       // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/ItemsDisplay/WBP_ImagePreviewArea.WBP_ImagePreviewArea_C.SetBannerPreviewContainer
	// void SetBannerPreviewContainer();                                                                                     // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ShowBGImage();                                                                                                   // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_ImagePreviewArea(int32_t EntryPoint);                                                       // [0x66265f0] Final                
};
...
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x0388   (0x0008)  
	SDK_UNDEFINED(1,3553) /* TEnumAsByte<EHorizontalAlignment> */ __um(GridItemAlignment);                         // 0x0390   (0x0001)  
	...
	SDK_UNDEFINED(1,3554) /* TEnumAsByte<EHorizontalAlignment> */ __um(ScrollbarAlignment);                        // 0x03C0   (0x0001)  
	...
	// void HandleAnalogInputEvent(FAnalogInputEvent& InAnalogInputEvent);                                                   // [0x66265f0] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CustomizationItemGridContainer(int32_t EntryPoint);                                         // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void UpdatePipVisual(int32_t PipSeed);                                                                                // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerProfile/WBP_CoreRankPip.WBP_CoreRankPip_C.SetState
	// void SetState(bool IsVisible, bool IsActivePip);                                                                      // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreRankPip(int32_t EntryPoint);                                                            // [0x66265f0] Final                
};
...
public:
	...
	// void SetPipsState(int32_t RankPipsCount, int32_t ActivePipsCount);                                                    // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ExecuteUbergraph_WBP_CorePlayerRank(int32_t EntryPoint);                                                         // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void Set Background Image(TWeakObjectPtr<UTexture2D*> Texture);                                                       // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CorePlayerRankWrapper(int32_t EntryPoint);                                                  // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void UpdateGauge(float PlayerExp, float NextLevelExp);                                                                // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnPlayMaxValueAnimation();                                                                                       // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CorePlayerLevelExpGauge(int32_t EntryPoint);                                                // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void SetViewData(FPlayerLevelViewData& PlayerLevelViewData);                                                          // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/PlayerProfile/WBP_CorePlayerLevel.WBP_CorePlayerLevel_C.SetDataFromViewData
	// void SetDataFromViewData(int32_t value, int32_t Value2);                                                              // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CorePlayerLevel(int32_t EntryPoint);                                                        // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_WBP_CoreKeyListenerInputPrompt(int32_t EntryPoint);                                             // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_WBP_LoadingSmall(int32_t EntryPoint);                                                           // [0x66265f0] Final                
};
...
public:
	...
	// void SetFontSize(int32_t Size);                                                                                       // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetBackgroundOpacity
	// void SetBackgroundOpacity(ESubtitlesBackgroundOpacity backgroundOpacity);                                             // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetPositionByAnchor
	// void SetPositionByAnchor(FVector2D position);                                                                         // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetSubtitlesPosition
	// void SetSubtitlesPosition(ESubtitlesPosition position);                                                               // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetConstrainAspectRatioChanged
	// void SetConstrainAspectRatioChanged(bool isConstrained, float AspectRatio);                                           // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetSubtitlesSize
	// void SetSubtitlesSize(ESubtitlesSize Size);                                                                           // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.SetSubtitlesBackgroundOpacity
	// void SetSubtitlesBackgroundOpacity(ESubtitlesBackgroundOpacity Opacity);                                              // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Common/WBP_CoreSubtitles.WBP_CoreSubtitles_C.ExecuteUbergraph_WBP_CoreSubtitles
	// void ExecuteUbergraph_WBP_CoreSubtitles(int32_t EntryPoint);                                                          // [0x66265f0] Final                
};
