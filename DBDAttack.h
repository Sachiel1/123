...
public:
	...
	// void OnLungeAttackStartCosmetic(class ADBDPlayer* killer);                                                            // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/DBDAttack.PounceAttackOpenSubstateCosmetic.OnLungeAttackEndCosmetic
	// void OnLungeAttackEndCosmetic(class ADBDPlayer* killer);                                                              // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/DBDAttack.PounceAttackOpenSubstateCosmetic.OnLocallyObservedChangedCosmetic
	// void OnLocallyObservedChangedCosmetic(class ADBDPlayer* killer);                                                      // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintEvent 
	// Function /Script/DBDAttack.PounceAttackOpenSubstateCosmetic.OnLocallyObservedChanged
	// void OnLocallyObservedChanged(class ADBDPlayer* killer);                                                              // [0x5305170] Final|Native|Private 
	// Function /Script/DBDAttack.PounceAttackOpenSubstateCosmetic.IsLungeAttackAugmented
	// bool IsLungeAttackAugmented(class ADBDPlayer* killer);                                                                // [0x53050d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
