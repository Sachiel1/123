...
public:
	...
	// void OnRep_EventDrivenConditionData_Internal(FModifierReplicatedEventConditionData& oldReplicatedCondition);          // [0x8a5f180] Final|Native|Private|HasOutParms 
	// Function /Script/Competence.BaseModifierContainer.IsApplicable
	// bool IsApplicable();                                                                                                  // [0x62193e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Competence.BaseModifierContainer.CreateAndSetEventDrivenCondition
	// class UEventDrivenModifierCondition* CreateAndSetEventDrivenCondition(class UClass* conditionType);                   // [0x8a5f0e0] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
...
public:
	...
	// void SetSubjectProviderClass(class UClass* subjectProviderClass);                                                     // [0x8a5ec60] Final|Native|Public|BlueprintCallable 
	// Function /Script/Competence.BaseModifierCondition.OnRep_SubjectProviderClass
	// void OnRep_SubjectProviderClass();                                                                                    // [0x8a5ec40] Final|Native|Private 
	// Function /Script/Competence.BaseModifierCondition.OnRep_OwningModifier
	// void OnRep_OwningModifier();                                                                                          // [0x8a5ec20] Final|Native|Private 
	// Function /Script/Competence.BaseModifierCondition.InitializeSubjectProviderClass
	// void InitializeSubjectProviderClass();                                                                                // [0x522fee0] Native|Event|Protected|BlueprintEvent 
	// Function /Script/Competence.BaseModifierCondition.GetOwningActor
	// class AActor* GetOwningActor();                                                                                       // [0x8a5ebf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetRange(float newRange);                                                                                        // [0x8a62130] Final|Native|Public|BlueprintCallable 
	// Function /Script/Competence.RangeBasedCondition.OnRep_Range
	// void OnRep_Range();                                                                                                   // [0x8a62110] Final|Native|Private 
};
...
public:
	...
	// void OnRep_Condition();                                                                                               // [0x8a623e0] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_Conditions();                                                                                              // [0x8a5f5d0] Final|Native|Private 
};
...
public:
	...
	// class UOrModifierCondition* Or(TScriptInterface<Class> ConditionReceiver);                                            // [0x8a600c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.Not
	// class UNotModifierCondition* Not(TScriptInterface<Class> ConditionReceiver);                                          // [0x8a60020] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.Lingering
	// class ULingeringModifierCondition* Lingering(TScriptInterface<Class> ConditionReceiver, float timeToTrack);           // [0x8a5ff30] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.IsTimerDone
	// class UIsTimerDoneCondition* IsTimerDone(TScriptInterface<Class> ConditionReceiver, class UTimerObject* Timer);       // [0x8a5fe40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.CreateRangeBasedConditionWithSubject
	// class URangeBasedCondition* CreateRangeBasedConditionWithSubject(TScriptInterface<Class> ConditionReceiver, class UClass* conditionType, float Range, class UClass* subjectProviderClass); // [0x8a5fcd0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.CreateRangeBasedCondition
	// class URangeBasedCondition* CreateRangeBasedCondition(TScriptInterface<Class> ConditionReceiver, class UClass* conditionType, float Range); // [0x8a5fb90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.CreateAndReceiveConditionWithSubjectForBP
	// class UEventDrivenModifierCondition* CreateAndReceiveConditionWithSubjectForBP(TScriptInterface<Class> ConditionReceiver, class UClass* conditionType, class UClass* subjectProviderClass); // [0x8a5fa60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.CreateAndReceiveConditionForBP
	// class UEventDrivenModifierCondition* CreateAndReceiveConditionForBP(TScriptInterface<Class> ConditionReceiver, class UClass* conditionType); // [0x8a5f970] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Competence.ConditionFactory.And
	// class UAndModifierCondition* And(TScriptInterface<Class> ConditionReceiver);                                          // [0x8a5f8d0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetState(FGameplayTag State);                                                                                    // [0x8a60e60] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetMaxDuration(float Duration);                                                                                  // [0x5c067c0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetTimer(class UTimerObject* Timer);                                                                             // [0x8a615f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Competence.IsTimerDoneCondition.OnRep_Timer
	// void OnRep_Timer();                                                                                                   // [0x8a615d0] Final|Native|Private 
};
...
public:
	...
	// void OnTimerEnd();                                                                                                    // [0x8a61950] Final|Native|Private 
};
