...
public:
	...
	// void UpdateMaterials();                                                                                               // [0x8aa6b50] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetVectorParameter
	// void SetVectorParameter(FName ParameterName, FVector& NewValue);                                                      // [0x8aa6a60] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetTextureParameter
	// void SetTextureParameter(FName ParameterName, class UTexture* newTexture);                                            // [0x8aa6970] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetStencilIntegerScalarParameter
	// void SetStencilIntegerScalarParameter(FName ParameterName, int32_t& NewValue);                                        // [0x8aa6880] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetScalarParameter
	// void SetScalarParameter(FName ParameterName, float NewValue);                                                         // [0x8aa6790] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetRenderInMainPass
	// void SetRenderInMainPass(bool inRenderInMainPass);                                                                    // [0x8aa6700] Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetRenderInCustomDepth
	// void SetRenderInCustomDepth(bool renderInCustomDepth);                                                                // [0x8aa6670] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetRenderInCustomColourNoDepth
	// void SetRenderInCustomColourNoDepth(bool renderInCustomColour);                                                       // [0x8aa65e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetReceivesDecals
	// void SetReceivesDecals(bool receivesDecals);                                                                          // [0x8aa6550] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetMaterial
	// void SetMaterial(FString GroupName);                                                                                  // [0x8aa64b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetLightingChannelForAllMeshes
	// void SetLightingChannelForAllMeshes(FLightingChannels LightingChannels);                                              // [0x8aa6430] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetCustomDepthStencilValue
	// void SetCustomDepthStencilValue(int32_t stencilValue);                                                                // [0x8aa63a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetColourParameter
	// void SetColourParameter(FName ParameterName, FLinearColor NewValue);                                                  // [0x8aa62b0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetCastCinematicShadows
	// void SetCastCinematicShadows(bool castCinematicShadows);                                                              // [0x8aa6220] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.SetAllToSameMaterial
	// void SetAllToSameMaterial(class UMaterialInterface* MaterialInterface);                                               // [0x8aa6190] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.ResetMaterials
	// void ResetMaterials();                                                                                                // [0x8aa6170] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.CopyFirstScalarParameter
	// bool CopyFirstScalarParameter(FName ParameterName, float& OutValue);                                                  // [0x8aa6070] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.BatchSetVisibility
	// void BatchSetVisibility(bool bNewVisibility, bool bPropagateToChildren);                                              // [0x8aa5fa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.BatchSetSkipComponentAndChildrenTransformUpdate
	// void BatchSetSkipComponentAndChildrenTransformUpdate(bool Skip);                                                      // [0x8aa5f10] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.BatchSetComponentTickEnabled
	// void BatchSetComponentTickEnabled(bool Enabled);                                                                      // [0x8aa5e80] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.BatchMeshCommands.AddGroup
	// void AddGroup(FMaterialNamedGroup Group);                                                                             // [0x8aa5d40] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetIgnoredPrimitives(TArray<UPrimitiveComponent*> ignoredPrimitives);                                            // [0x8aa6dc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.ClippableProviderComponent.AddIgnoredPrimitives
	// void AddIgnoredPrimitives(TArray<UPrimitiveComponent*>& ignoredPrimitives);                                           // [0x8aa6d10] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetIBLMultiplicator(float IBLMultiplicator);                                                                     // [0x8aa7d90] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.DBDReflectionCaptureSpawnerComponent.SetContributionFactor
	// void SetContributionFactor(float ContributionFactor);                                                                 // [0x8aa7d10] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.DBDReflectionCaptureSpawnerComponent.SetBrightness
	// void SetBrightness(float Brightness);                                                                                 // [0x8aa7c90] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ActivateVFX(class USkeletalMeshComponent* SkeletalMeshComponent, bool Active);                                   // [0x8aa8090] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetRandomizeLength(bool isRandom);                                                                               // [0x8aa8d30] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.SetMinLength
	// void SetMinLength(float newMinValue);                                                                                 // [0x8aa8cb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.SetMaxLength
	// void SetMaxLength(float newMaxValue);                                                                                 // [0x8aa8c30] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.SetLightToMaxValue
	// void SetLightToMaxValue();                                                                                            // [0x8aa8c10] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.SetLightCurve
	// void SetLightCurve(class UCurveFloat* lightcurve);                                                                    // [0x8aa8b80] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.Reset
	// void Reset();                                                                                                         // [0x8aa8b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.RegisterForTick
	// void RegisterForTick();                                                                                               // [0x8aa8b40] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.DeactivateTick
	// void DeactivateTick();                                                                                                // [0x8aa8b20] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.AddMaterialHelper
	// void AddMaterialHelper(class UMaterialHelper* matHelper, FName propName, float Multiplier);                           // [0x8aa89f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.LightIntensityTimelineComponent.AddLight
	// void AddLight(class ULightComponent* Light, float Multiplier);                                                        // [0x8aa8920] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RefreshMeshes();                                                                                                 // [0x8aa9240] Final|Native|Public|BlueprintCallable 
	// Function /Script/GFXUtilities.MaterialHelper.RefreshMesh
	// void RefreshMesh(class UMeshComponent* mc);                                                                           // [0x8aa91b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetIntensity(float Intensity);                                                                                   // [0x8aa9b90] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void EnableCopyStencilToCustomStencil(bool Enabled);                                                                  // [0x8aa9e90] Final|Native|Static|Public|BlueprintCallable 
};
