...
public:
	...
	// void InitAsOpen();                                                                                                    // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void InitAsOpen_ISlidingDoor(class UChildActorComponent* ChildActorComponent, class UObject* __WorldContext);         // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.InitAsOpen_Qatar
	// void InitAsOpen_Qatar(class UChildActorComponent* ChildActorComponent, class UObject* __WorldContext);                // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.SetGeneratorDrivenScoreEvent
	// void SetGeneratorDrivenScoreEvent(TArray<AActor*>& generators, class UObject* __WorldContext);                        // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.CheckBasement
	// void CheckBasement(class UTileSpawnPoint* SpawnPoint, class AActor* spawnedObject, class UObject* __WorldContext);    // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.CheckGenerator
	// void CheckGenerator(class UTileSpawnPoint* SpawnPoint, class AActor* spawnedObject, class UObject* __WorldContext);   // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.CallForSpawn
	// void CallForSpawn(class UActorSpawner* ActorSpawner, class UObject* __WorldContext);                                  // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.SelectSpawners
	// void SelectSpawners(TArray<UActorSpawner*>& Spawners, int32_t MinCount, int32_t MaxCount, FRandomStream Stream, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.SelectSpawner
	// void SelectSpawner(TArray<UActorSpawner*>& Spawners, FRandomStream Stream, class UObject* __WorldContext);            // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.SetupGeneratorDrivenElements
	// void SetupGeneratorDrivenElements(TArray<UChildActorComponent*>& SpawnPoints, class AActor* GeneratorSpawnPoint, int32_t generatorId, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileUtilities.TileUtilities_C.SelectSpawnpoint
	// void SelectSpawnpoint(TArray<UTileSpawnPoint*>& SpawnPoints, FRandomStream Stream, class UObject* __WorldContext);    // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SelectSpawnpoint(TArray<UTileSpawnPoint*>& Array);                                                               // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileBase01.TileBase01_C.SetupGeneratorDrivenElements
	// void SetupGeneratorDrivenElements(class AActor* GeneratorSpawnPoint, TArray<UChildActorComponent*>& GeneratorDrivenElements); // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void OnLevelLoaded();                                                                                                 // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileBase01.TileBase01_C.SetGeneratorDrivenObjects
	// void SetGeneratorDrivenObjects(class UTileSpawnPoint* SpawnPoint, class AActor* spawnedObject);                       // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tiles/TileBase01.TileBase01_C.SetGeneratorDrivenScoreEvent
	// void SetGeneratorDrivenScoreEvent(TArray<AActor*>& generators);                                                       // [0x66265f0] Net|NetReliableNetMulticast|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_TileBase01(int32_t EntryPoint);                                                                 // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void ConstructionScript();                                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnAudioStarted();                                                                                                // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Game/Blueprints/Events/Anniversary2023/UmbraCommentatorActor.UmbraCommentatorActor_C.OnAudioEnded
	// void OnAudioEnded();                                                                                                  // [0x66265f0] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_UmbraCommentatorActor(int32_t EntryPoint);                                                      // [0x66265f0] Final                
};
...
public:
	...
	// void Cosmetic_OnFootHitGround();                                                                                      // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_K34TipToeDistraction(int32_t EntryPoint);                                                    // [0x66265f0] Final                
};
...
public:
	...
	// void ReceiveBeginPlay();                                                                                              // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tunables/BP_TextDesignTunables.BP_TextDesignTunables_C.ReceiveTick
	// void ReceiveTick(float DeltaSeconds);                                                                                 // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Tunables/BP_TextDesignTunables.BP_TextDesignTunables_C.ExecuteUbergraph_BP_TextDesignTunables
	// void ExecuteUbergraph_BP_TextDesignTunables(int32_t EntryPoint);                                                      // [0x66265f0] Final                
};
...
public:
	...
	// TArray<ADBDPlayer*> FetchInteractingPlayers(class UInteractionDefinition* Chargeable Interaction, class ADBDPlayer* Interacting Player); // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	...
	// float Compute Overall speed including multiple interactors(class UChargeableInteractionDefinition* Chargeable Interaction, class ADBDPlayer* Interacting Player); // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool ShouldAndCanShowMultipleActorsSpeedProficiency(class UChargeableInteractionDefinition* Chargeable Interaction);  // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Blueprints/InteractionProficiencies/ActionSpeedProficiency.ActionSpeedProficiency_C.GetValue
	// float GetValue(class UChargeableInteractionDefinition* chargeableInteraction, class ADBDPlayer* Player);              // [0x66265f0] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// bool GetIsActive(class UChargeableInteractionDefinition* chargeableInteraction, class ADBDPlayer* Player);            // [0x66265f0] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// EStatusEffectType GetType(float value);                                                                               // [0x66265f0] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
...
public:
	...
	// void IsSpecificCharacterInLobby(FString& Character, bool& success);                                                   // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.GetPlayableEvents
	// void GetPlayableEvents(TArray<FAkEventWithSubtitle>& AudioEvents, bool& ShouldPlay, TArray<FAkEventWithSubtitle>& PlayableEvents); // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.GetLocalCharacterName
	// void GetLocalCharacterName(FString& characterName);                                                                   // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.FindSpecificDialogueForCharacter
	// void FindSpecificDialogueForCharacter(TArray<FSpecificReactionDialogue>& ReactionDialogues, FString Character, TArray<FAkEventWithSubtitle>& Dialogue, bool& success); // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC11
	// void ShouldPlayC11(bool& ShouldPlay);                                                                                 // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC10
	// void ShouldPlayC10(TMap<UAkAudioEvent*, FAkEventWithSubtitle>& ResponseDialogue, bool& ShouldPlay);                   // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC9
	// void ShouldPlayC9(TMap<UAkAudioEvent*, FAkEventWithSubtitle>& ResponseDialogue, bool& ShouldPlay);                    // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC8
	// void ShouldPlayC8(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC7
	// void ShouldPlayC7(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC6
	// void ShouldPlayC6(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC5
	// void ShouldPlayC5(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC4
	// void ShouldPlayC4(TArray<FAkEventWithSubtitle>& FoundDialogue, bool& ShouldPlay);                                     // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC3
	// void ShouldPlayC3(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC2
	// void ShouldPlayC2(TArray<FAkEventWithSubtitle>& FoundDialogue, bool& ShouldPlay);                                     // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ShouldPlayC1
	// void ShouldPlayC1(bool& ShouldPlay);                                                                                  // [0x66265f0] Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnPlayerMaxPrestige
	// void OnPlayerMaxPrestige(class UAkGameObject* AudioTarget);                                                           // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnCharacterRespond
	// void OnCharacterRespond(class UAkComponent* AudioTarget, FString PreviousContext);                                    // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnLobbyWait
	// void OnLobbyWait(class UAkComponent* AudioTarget);                                                                    // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnLocalReady
	// void OnLocalReady(class UAkComponent* AudioTarget, bool IsReady);                                                     // [0x66265f0] Protected|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnGuestSpawn
	// void OnGuestSpawn(class ADBDMenuPlayer* Guest, class UAkComponent* AudioTarget);                                      // [0x66265f0] Protected|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnLocalSpawn
	// void OnLocalSpawn(class UAkComponent* AudioTarget);                                                                   // [0x66265f0] Protected|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnGuestPlayerSpawn
	// void OnGuestPlayerSpawn(class ADBDMenuPlayer* Player, class UAkComponent* AudioTarget);                               // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnLocalPlayerReadyChanged
	// void OnLocalPlayerReadyChanged(class ADBDMenuPlayer* Player, class UAkComponent* AudioTarget);                        // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnLocalPlayerSpawn
	// void OnLocalPlayerSpawn(class UAkComponent* AudioTarget);                                                             // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnDialogueFinished
	// void OnDialogueFinished(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo);                           // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnAllPlayersReadyInOnlineLobby
	// void OnAllPlayersReadyInOnlineLobby();                                                                                // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.ReceiveEndPlay
	// void ReceiveEndPlay(TEnumAsByte<EEndPlayReason> EndPlayReason);                                                       // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnGuestPlayerDespawned
	// void OnGuestPlayerDespawned(class ADBDMenuPlayer* Player);                                                            // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnBeginPlay
	// void OnBeginPlay(class UAkComponent* AudioTarget, class ADBDMenuPlayer* Player);                                      // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnDialogueFinishedC2
	// void OnDialogueFinishedC2(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo);                         // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnDialogueFinishedC4
	// void OnDialogueFinishedC4(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo);                         // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Dialogue/LobbyDialogueComponent.LobbyDialogueComponent_C.OnMaxPrestige
	// void OnMaxPrestige(class UAkGameObject* AudioTarget);                                                                 // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_LobbyDialogueComponent(int32_t EntryPoint);                                                     // [0x66265f0] Final                
};
...
public:
	...
	// void Authority_OnInstantiateModifierConditions();                                                                     // [0x66265f0] BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_Mori_StatusEffect(int32_t EntryPoint);                                                       // [0x66265f0] Final                
};
...
public:
	...
	// void SetTunableValues();                                                                                              // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Crow Dissolve__FinishedFunc();                                                                                   // [0x66265f0] BlueprintEvent       
	...
	// void StartSpawnSequence(bool withRandomDelay);                                                                        // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/Entity/CamperTrackers/BP_ExposerCrow.BP_ExposerCrow_C.SetIsInteriorBP
	// void SetIsInteriorBP(bool interior);                                                                                  // [0x66265f0] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/Entity/CamperTrackers/BP_ExposerCrow.BP_ExposerCrow_C.CustomEvent
	// void CustomEvent(EAkResult Result);                                                                                   // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_ExposerCrow(int32_t EntryPoint);                                                             // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void UnregisterEventListener(FGameEventDispatcherHandleBP Game Event Delegate Handle, class UObject* __WorldContext); // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Util/BPFL_EventFunctions.BPFL_EventFunctions_C.LocallyDispatchEvent
	// void LocallyDispatchEvent(FGameplayTag gameEventType, class ADBDPlayer* Instigator, class AActor* Target, float Custom Value, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Util/BPFL_EventFunctions.BPFL_EventFunctions_C.RemotelyDispatchEvent
	// void RemotelyDispatchEvent(FGameplayTag gameEventType, class ADBDPlayer* Instigator, class AActor* Target, float Custom Value, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Util/BPFL_EventFunctions.BPFL_EventFunctions_C.RegisterEventListener
	// void RegisterEventListener(FDelegateProperty Game Event Delegate, FGameplayTag Filter, class UObject* __WorldContext, FGameEventDispatcherHandleBP& GameEventDispatcherHandle); // [0x66265f0] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void GetDetectionZoneIntensity(TEnumAsByte<LightingInterfaceEnum>& BP Type, float& DetectionZoneCylinderIntensityOverride, float& DetectionZoneDecalIntensityOverride); // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void GetCondemnedStatusVignetteIntensity(TEnumAsByte<LightingInterfaceEnum>& BP Type, float& CondemnedStatusIntensityOverride); // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/Lighting/LightingInterface.LightingInterface_C.SetPostOverride
	// void SetPostOverride(FPostProcessSettings PostSettings, class UPostProcessComponent* postProcess);                    // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/Lighting/LightingInterface.LightingInterface_C.GetLightingPost
	// void GetLightingPost(TArray<UPostProcessComponent*>& postProcess, TEnumAsByte<LightingInterfaceEnum>& BP Type);       // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/Lighting/LightingInterface.LightingInterface_C.GetBasementPost
	// void GetBasementPost(TEnumAsByte<LightingInterfaceEnum>& BP Type, FDBDPerPlatformFloat& Override);                    // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void StopCameraShake();                                                                                               // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/EndGame/EndGameEffectsComponent.EndGameEffectsComponent_C.PlayCameraShake
	// void PlayCameraShake(class UClass* CameraShake);                                                                      // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/EndGame/EndGameEffectsComponent.EndGameEffectsComponent_C.GetDBDPlayer
	// void GetDBDPlayer(class ADBDPlayer*& Player);                                                                         // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnTimeDilationChanged(FGameplayTag gameEventType, FGameEventData& GameEventData);                                // [0x66265f0] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/EndGame/EndGameEffectsComponent.EndGameEffectsComponent_C.EndGameOver
	// void EndGameOver(FGameplayTag gameEventType, FGameEventData& GameEventData);                                          // [0x66265f0] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/GameplayElements/EndGame/EndGameEffectsComponent.EndGameEffectsComponent_C.StartEndGameEffects
	// void StartEndGameEffects(bool JustStarted);                                                                           // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ReminderEffect(FGameplayTag gameEventType, FGameEventData& GameEventData);                                       // [0x66265f0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_EndGameEffectsComponent(int32_t EntryPoint);                                                    // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void InOtherWorld(bool& InPhysicalWorld);                                                                             // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void GetRandomLocationNearKillerMesh(FTransform& Transform);                                                          // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void SpawnAfterImage(FTransform& huskTransform, float opacityValue, float speedValue);                                // [0x66265f0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ReceiveBeginPlay();                                                                                              // [0x66265f0] Event|Public|BlueprintEvent 
	...
	// void AfterImagesSpawningLoop();                                                                                       // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ShouldShowAfterImageChanged(bool shouldBeVisible);                                                               // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	...
	// void UpdateCustomization();                                                                                           // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_AfterImageComponent(int32_t EntryPoint);                                                     // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void GetOwningSkeletalMesh(class UAnimInstance* Anim Instance, class UObject* __WorldContext, class USkeletalMeshComponent*& Skeletal Mesh Component); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
