...
public:
	...
	// void PostEventByNameOnComponent(class UAkComponent* Component, FString audioEventName);                               // [0x53091e0] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.PostAkAudioEvent
	// void PostAkAudioEvent(class UAkAudioEvent* AudioEvent);                                                               // [0x5309160] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.DBD_UnloadAudioBank
	// void DBD_UnloadAudioBank(class UAkAudioBank* Bank, class UObject* WorldContextObject);                                // [0x53090a0] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.DBD_LoadAudioBankWithCallback
	// void DBD_LoadAudioBankWithCallback(class UAkAudioBank* Bank, FDelegateProperty& BankLoadedCallback, class UObject* WorldContextObject); // [0x5308f60] Final|BlueprintCosmetic|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.DBD_LoadAudioBankPersistentWithCallback
	// void DBD_LoadAudioBankPersistentWithCallback(class UAkAudioBank* Bank, FDelegateProperty& BankLoadedCallback, class UObject* WorldContextObject); // [0x5308e20] Final|BlueprintCosmetic|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.DBD_LoadAudioBankPersistent
	// void DBD_LoadAudioBankPersistent(class UAkAudioBank* Bank, class UObject* WorldContextObject);                        // [0x5308d30] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAudio.AudioUtilities.DBD_LoadAudioBank
	// void DBD_LoadAudioBank(class UAkAudioBank* Bank, class UObject* WorldContextObject);                                  // [0x5308d30] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool PostAkEvent(class UAkAudioEvent* AkEvent);                                                                       // [0x53094b0] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/DBDAudio.InteractionAudioComponent.GetCalculatedAudioRadius
	// float GetCalculatedAudioRadius();                                                                                     // [0x5309480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
