...
public:
	...
	// void OnVideoAssetLoaded();                                                                                            // [0x8a94c80] Final|Native|Private 
	// Function /Script/DBDVideoPlayer.VideoThumbnailPlayer.OnMediaOpened
	// void OnMediaOpened(FString OpenedUrl);                                                                                // [0x8a94b90] Final|Native|Private 
	// Function /Script/DBDVideoPlayer.VideoThumbnailPlayer.OnMediaClosed
	// void OnMediaClosed();                                                                                                 // [0x8a94b70] Final|Native|Private 
	// Function /Script/DBDVideoPlayer.VideoThumbnailPlayer.OnEndReached
	// void OnEndReached();                                                                                                  // [0x8a94b50] Final|Native|Private 
};
