...
public:
	...
	// void Cosmetic_UpdateIndicatorActivationStatus(bool IsActivated);                                                      // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// TArray<ASurvivorCosmeticHelperActor*> GetCosmeticHelperActorsOfSurvivorByClass(class ACamperPlayer* Survivor, class UClass* cosmeticHelperActorClassType); // [0x545e0e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DBDCosmetic.DBDCosmeticModuleUtilities.GetCosmeticHelperActorsOfSurvivor
	// TArray<ASurvivorCosmeticHelperActor*> GetCosmeticHelperActorsOfSurvivor(class ACamperPlayer* Survivor);               // [0x545e010] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool IsLocallyObserved();                                                                                             // [0x545e690] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.GetSurvivor
	// class ACamperPlayer* GetSurvivor();                                                                                   // [0x545e660] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.GetMaterialHelper
	// class UMaterialHelper* GetMaterialHelper();                                                                           // [0x545e630] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.GetCustomizedSkeletalMesh
	// class UCustomizedSkeletalMesh* GetCustomizedSkeletalMesh();                                                           // [0x545e600] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.GetAudioComponent
	// class UAkComponent* GetAudioComponent();                                                                              // [0x545e5d0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.Cosmetic_OnSurvivorLinked
	// void Cosmetic_OnSurvivorLinked(class ACamperPlayer* survivorLinked);                                                  // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.Cosmetic_OnIsLocallyObservingSurvivorChanged
	// void Cosmetic_OnIsLocallyObservingSurvivorChanged(bool isLocallyObservingSurvivor);                                   // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperActor.Cosmetic_OnIsGettingMoriedStatusChanged
	// void Cosmetic_OnIsGettingMoriedStatusChanged(bool isGettingMoried);                                                   // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// TArray<ASurvivorCosmeticHelperActor*> GetCosmeticHelperActors();                                                      // [0x545eac0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCosmetic.SurvivorCosmeticHelperSpawnerComponent.GetCosmeticHelperActorByClass
	// TArray<ASurvivorCosmeticHelperActor*> GetCosmeticHelperActorByClass(class UClass* cosmeticHelperActorClassType);      // [0x545e9e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
