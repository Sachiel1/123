...
public:
	...
	// void OnLocallyObservedChanged();                                                                                      // [0x51cd530] Final|Native|Private 
	// Function /Script/Anniversary.CrownPillarInteractable.Local_OnIntroCompleted
	// void Local_OnIntroCompleted();                                                                                        // [0x51cd510] Final|Native|Private 
	// Function /Script/Anniversary.CrownPillarInteractable.IsLocallyObservedPlayerEquippedWithAnniversaryOffering
	// bool IsLocallyObservedPlayerEquippedWithAnniversaryOffering();                                                        // [0x51cd4e0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	...
	// void Cosmetic_OnInteractionCancelled();                                                                               // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void Cosmetic_SetVFXParticlesVisibility(bool IsVisible);                                                              // [0x66265f0] Event|Protected|BlueprintEvent 
};
