...
public:
	...
	// void KNY_StartSnowstorm();                                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ReceiveTick(float DeltaSeconds);                                                                                 // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Game/Effects/Blueprints/BP_Effect_Mist.BP_Effect_Mist_C.ExecuteUbergraph_BP_Effect_Mist
	// void ExecuteUbergraph_BP_Effect_Mist(int32_t EntryPoint);                                                             // [0x66265f0] Final                
};
...
public:
	...
	// void SequenceEvent__ENTRYPOINTSequenceDirector(TScriptInterface<BlueprintGeneratedClass> Target);                     // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Sequence/Lobby/StartScreen/SQ_fade_menu.SequenceDirector_C.FadeOutEvent
	// void FadeOutEvent();                                                                                                  // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Sequence/Lobby/StartScreen/SQ_fade_menu.SequenceDirector_C.SQ_FadedOutEvent
	// void SQ_FadedOutEvent(TScriptInterface<BlueprintGeneratedClass> Target);                                              // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Sequence/Lobby/StartScreen/SQ_fade_menu.SequenceDirector_C.ExecuteUbergraph_SequenceDirector
	// void ExecuteUbergraph_SequenceDirector(int32_t EntryPoint);                                                           // [0x66265f0] Final                
};
...
public:
	...
	// void BndEvt__BP_Lobby_StartScreen_Lite_P_Lobby_StartScreen_Lite_K2Node_ComponentBoundEvent_0_ParticleSpawnSignature__DelegateSignature(FName EventName, float EmitterTime, FVector Location, FVector Velocity); // [0x66265f0] BlueprintEvent       
	...
	// void ExecuteUbergraph_BP_Lobby_StartScreen_Lite(int32_t EntryPoint);                                                  // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void Spawn Niagara Particles Character Dissolve(bool Survivor/Killer, class AActor* Actor, class UCustomizedSkeletalMesh* CustomizedSkeletalMesh, bool In/Out, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void SpawnFootstepKillerVFX(bool Run, bool Left, class ASlasherPlayer* SlasherPlayer, class UObject* __WorldContext); // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.SpawnFootstepVFX
	// void SpawnFootstepVFX(bool Run, bool Left, class ACamperPlayer* CamperCharacter, class UObject* __WorldContext, bool& Bloody Footprints, FName& Footprint Socket, int32_t& Surface Type); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.ManageInteractiveMist
	// void ManageInteractiveMist(class APawn* Pawn, class UActorComponent* MistActor, class UObject* __WorldContext);       // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MakeCharacter_Visible
	// void MakeCharacter_Visible(class ADBDPlayer* Character, class UObject* __WorldContext);                               // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void MakeCharacter_Invisible(class ADBDPlayer* Character, class UObject* __WorldContext);                             // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Visible
	// void MaskFPV_Visible(class ADBDPlayer* Character, class UObject* __WorldContext);                                     // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_Function_Lib_Character.VFX_Function_Lib_Character_C.MaskFPV_Hidden
	// void MaskFPV_Hidden(class ADBDPlayer* Character, class UObject* __WorldContext);                                      // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Get_BP_MenuBaseCamper(class ABP_Menu_Base_Camper_C*& BP_MenuBaseCamper);                                         // [0x66265f0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SetCamperMenuAnimationState(TEnumAsByte<Enum_CamperMenuAnimationState> State);                                   // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/Camper/BPI_SurvivorMenu_Anim.BPI_SurvivorMenu_Anim_C.IsPlayingMenuInterrupt
	// void IsPlayingMenuInterrupt(bool IsPlayingAnimation);                                                                 // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void K03_FX_ShowChainsaw();                                                                                           // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void K08_FX_MakeHatchetDisappear();                                                                                   // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K08/BPI_Effect_K08.BPI_Effect_K08_C.K08_FX_MakeHatchetAppear
	// void K08_FX_MakeHatchetAppear();                                                                                      // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void K24_FX_HideTentacle();                                                                                           // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K24/BPI_Effect_K24_Menu.BPI_Effect_K24_Menu_C.K24_FX_ShowTentacle
	// void K24_FX_ShowTentacle();                                                                                           // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// bool Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation);                  // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration); // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void Camper_AntidoteBoostVignette_End();                                                                              // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// bool HandleKillerNotifies_Trickster(FName Selection, class ASlasherPlayer* MySlasher, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Blight(class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);                   // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Deathslinger(class ASlasherPlayer* My Slasher1, FName Selection, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Oni(class UObject* Target, class UObject* Get Killer1, FName Selection, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Demogorgon(FName Selection, class UObject* Target, class UObject* __WorldContext);          // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Nurse(FName Selection, class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);   // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Hag(FName Selection, class ASlasherPlayer* My Slasher1, class UObject* __WorldContext);     // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void HandleKillerNotifies_Trapper(class UObject* __WorldContext);                                                     // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_General(class ASlasherPlayer* My Slasher1, FName Selection, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void HandleKillerNotifies_WallBreak(FName Selection, class UObject* WorldContextObject, class UObject* __WorldContext, bool& Return Value); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// bool HandleKillerNotifies_Footsteps(FName Selection, class ASlasherPlayer* Slasher, class UObject* __WorldContext);   // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void K13_FX_Mori_SpawnPoseableMesh(bool First Time to Mori);                                                          // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_Mori_ResetVariable
	// void K13_FX_Mori_ResetVariable();                                                                                     // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_Vault_SpawnPoseableMesh
	// void K13_FX_Vault_SpawnPoseableMesh();                                                                                // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_CarryAttack_WeaponDisappear
	// void K13_FX_CarryAttack_WeaponDisappear();                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_K13_Killer.BPI_K13_Killer_C.K13_FX_CarryAttack_BOW
	// void K13_FX_CarryAttack_BOW();                                                                                        // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void K13_FX_MakeSwordNotVisible_Attack_Wipe_FPV();                                                                    // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// bool HandleAnimNotify(class AActor* Player, FName& NotifyName);                                                       // [0x66265f0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	...
	// void ExecuteUbergraph_BP_VFX_Slasher_13_AnimNotifies_Handler(int32_t EntryPoint);                                     // [0x66265f0] Final                
};
...
public:
	...
	// void K13_FX_ModifyFace(float SadFaceCurveValue, float MadFaceCurveValue);                                             // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_Effect_K13_Menu.BPI_Effect_K13_Menu_C.K13_FX_MakeSwordInvisible
	// void K13_FX_MakeSwordInvisible();                                                                                     // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void K13_FX_MakeSwordDisappear();                                                                                     // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K13/BPI_Effect_K13_Menu.BPI_Effect_K13_Menu_C.K13_FX_MakeSwordAppear
	// void K13_FX_MakeSwordAppear();                                                                                        // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// FTransform GetDecalTransform(class USceneComponent* Mesh, class UObject* __WorldContext);                             // [0x66265f0] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.SpawnBleedEffect
	// void SpawnBleedEffect(class USceneComponent* Mesh, class UObject* __WorldContext, class UParticleSystemComponent*& ParticleSystem); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.SpawnBloodSpurtsParticles
	// class UNiagaraComponent* SpawnBloodSpurtsParticles(class USceneComponent* Mesh, class UObject* __WorldContext);       // [0x66265f0] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.GetSlasherBloodOpacityPlayrate
	// float GetSlasherBloodOpacityPlayrate(class UObject* __WorldContext);                                                  // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.GetBloodFramePlayRate
	// float GetBloodFramePlayRate(class UObject* __WorldContext);                                                           // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.CreatePP_BloodMaterial
	// void CreatePP_BloodMaterial(class UObject* __WorldContext, class UMaterialInstanceDynamic*& PostProcessMaterialInstance); // [0x66265f0] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.ManagePostProcessParameters
	// void ManagePostProcessParameters(bool Add/Remove, class UCameraComponent* Camera, class UObject* PostProcessMaterial, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.RandomizeBloodPostProcess
	// void RandomizeBloodPostProcess(class UMaterialInstanceDynamic* MaterialInstance, class ADBDPlayer* DBDPlayer, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Libraries/VFX_FunctionLib_Blood.VFX_FunctionLib_Blood_C.RandomizeBloodLayer
	// void RandomizeBloodLayer(class UMaterialInstanceDynamic* MaterialInstance, FName OffsetX_MaterialParameter, FName OffsetY_MaterialParameter, FName Texture_MaterialParameter, FName Scale_Parameter, int32_t Dimension 1, class UObject* __WorldContext); // [0x66265f0] Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Pause And Reset Flicker(bool isFlickerPaused);                                                                   // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void FX_K27_InteractionStart_Vignette();                                                                              // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K27/BPI_Effect_Onryo.BPI_Effect_Onryo_C.CosmeticOnUnmanifestChargeChanged
	// void CosmeticOnUnmanifestChargeChanged(float Charge Percent);                                                         // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Blueprints/Interface/K27/BPI_Effect_Onryo.BPI_Effect_Onryo_C.CosmeticOnManifestChargeChanged
	// void CosmeticOnManifestChargeChanged(float Charge Percent);                                                           // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(1,4195) /* TEnumAsByte<ETimelineDirection> */ __um(Fade__Direction_5487A9754B5AE15B4E9D0F8644A2CE40); // 0x0274   (0x0001)  
	...
	// void Fade__FinishedFunc();                                                                                            // [0x66265f0] BlueprintEvent       
	...
	// void Fade__UpdateFunc();                                                                                              // [0x66265f0] BlueprintEvent       
	...
	// void Fade__RemoveVFX__EventFunc();                                                                                    // [0x66265f0] BlueprintEvent       
	...
	// void HideHusk();                                                                                                      // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_Effect_K27_AfterImage_01(int32_t EntryPoint);                                                // [0x66265f0] Final                
};
...
public:
	...
	SDK_UNDEFINED(1,4196) /* TEnumAsByte<ETimelineDirection> */ __um(TML_PP_IdleInterrupt_02__Direction_A015685E4996C78ADD577788FC36D84F); // 0x024C   (0x0001)  
	...
	// void TML_PP_IdleInterrupt_02__FinishedFunc();                                                                         // [0x66265f0] BlueprintEvent       
	...
	// void TML_PP_IdleInterrupt_02__UpdateFunc();                                                                           // [0x66265f0] BlueprintEvent       
	...
	// void Destroy_PP_IdleInterrupt_02();                                                                                   // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_k27_MenuIdleInterrupt_02(int32_t EntryPoint);                                                // [0x66265f0] Final|HasDefaults    
};
...
public:
	...
	// void UserConstructionScript();                                                                                        // [0x66265f0] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_k27_IdleInterrupt_01(int32_t EntryPoint);                                                    // [0x66265f0] Final                
};
...
public:
	...
	// void FX_SpawnDissolveEmitter(bool HideWeapon, bool FPV, class USceneComponent* Mesh, class UObject* __WorldContext);  // [0x66265f0] Static|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void AnimNotify_Quesita_MenuDissolve_Out();                                                                           // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_Quesita_MenuDissolve_In();                                                                            // [0x66265f0] Public|BlueprintCallable|BlueprintEvent 
};
