...
public:
	...
	// void SetEventBackground(FString EventThemeLabel);                                                                     // [0x66265f0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Alerts/WBP_CoreAlerts.WBP_CoreAlerts_C.SetData
	// void SetData(TArray<FRewardWrapperViewData>& Data, TArray<UUserWidget*>& Widget);                                     // [0x66265f0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Alerts/WBP_CoreAlerts.WBP_CoreAlerts_C.Finished_4A3EFA3847957701465B81AFF62B0D0D
	// void Finished_4A3EFA3847957701465B81AFF62B0D0D();                                                                     // [0x66265f0] BlueprintCallable|BlueprintEvent 
	// Function /DBDUICore/Alerts/WBP_CoreAlerts.WBP_CoreAlerts_C.Finished_51CB27344662389D77C9C3A24FE729B8
	// void Finished_51CB27344662389D77C9C3A24FE729B8();                                                                     // [0x66265f0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WBP_CoreAlerts(int32_t EntryPoint);                                                             // [0x66265f0] Final|HasDefaults    
};
