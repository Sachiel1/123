...
public:
	...
	// void SetDissolveStarted(bool isDissolveStarted);                                                                      // [0x523cb00] Final|Native|Public|BlueprintCallable 
	// Function /Script/Barrel2023.Barrel.OnRep_OnLocationChanged
	// void OnRep_OnLocationChanged();                                                                                       // [0x523cae0] Final|Native|Private 
	// Function /Script/Barrel2023.Barrel.OnBarrelDespawnCosmeticsComplete
	// void OnBarrelDespawnCosmeticsComplete();                                                                              // [0x523cac0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnStoppedInteracting
	// void Cosmetic_OnStoppedInteracting();                                                                                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnStartedInteracting
	// void Cosmetic_OnStartedInteracting(class ADBDPlayer* interactingPlayer, float interactionDuration);                   // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnInteractionInterruptedByPlayer
	// void Cosmetic_OnInteractionInterruptedByPlayer();                                                                     // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnInteractionCompleted
	// void Cosmetic_OnInteractionCompleted(class ADBDPlayer* interactingPlayer);                                            // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnFirstBarrelSpawn
	// void Cosmetic_OnFirstBarrelSpawn();                                                                                   // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnBarrelRespawn
	// void Cosmetic_OnBarrelRespawn();                                                                                      // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/Barrel2023.Barrel.Cosmetic_OnBarrelDespawn
	// void Cosmetic_OnBarrelDespawn(bool wasInteractionCompleted);                                                          // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void DBD_BarrelSpawnRedBarrel();                                                                                      // [0x523d150] Final|Exec|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.DBD_BarrelSpawnGreenBarrel
	// void DBD_BarrelSpawnGreenBarrel();                                                                                    // [0x523d130] Final|Exec|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.DBD_BarrelSpawnBlueBarrel
	// void DBD_BarrelSpawnBlueBarrel();                                                                                     // [0x523d110] Final|Exec|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.DBD_BarrelPauseAllTimers
	// void DBD_BarrelPauseAllTimers(bool shouldPause);                                                                      // [0x523d080] Final|Exec|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.DBD_BarrelDebugBarrelSpawnPositions
	// void DBD_BarrelDebugBarrelSpawnPositions(float Duration);                                                             // [0x523d000] Final|Exec|Native|Private|Const 
	// Function /Script/Barrel2023.BarrelEventComponent.Authority_OnIntroComplete
	// void Authority_OnIntroComplete();                                                                                     // [0x523cfe0] Final|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.Authority_OnBarrelTimerDone
	// void Authority_OnBarrelTimerDone(class ARespawnableInteractable* RespawnableInteractable);                            // [0x523cf50] Final|Native|Private 
	// Function /Script/Barrel2023.BarrelEventComponent.Authority_OnBarrelInteractionChanged
	// void Authority_OnBarrelInteractionChanged(class ARespawnableInteractable* RespawnableInteractable, bool IsInteracting); // [0x523ce80] Final|Native|Private 
};
...
public:
	...
	// void Server_SetCharmInfo(bool isRedUnlocked, bool isGreenUnlocked, bool isBlueUnlocked);                              // [0x523d7b0] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/Barrel2023.BarrelPlayerComponent.GetInteractedBarrels
	// TArray<EBarrelType> GetInteractedBarrels();                                                                           // [0x523d720] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Barrel2023.BarrelPlayerComponent.DBD_BarrelResetInteractedBarrels
	// void DBD_BarrelResetInteractedBarrels();                                                                              // [0x523d700] Final|Exec|Native|Private 
	// Function /Script/Barrel2023.BarrelPlayerComponent.Cosmetic_TriggerPlayerVignette
	// void Cosmetic_TriggerPlayerVignette(class ADBDPlayer* Player, EBarrelType BarrelType);                                // [0x66265f0] BlueprintCosmetic|Event|Public|BlueprintCallable|BlueprintEvent 
};
