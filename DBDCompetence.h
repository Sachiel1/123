...
public:
	...
	// void Authority_Start(float Duration);                                                                                 // [0x5443550] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void Authority_OnHookCamper(FGameplayTag GameEvent, FGameEventData& GameEventData);                                   // [0x54430d0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void Authority_Start(float Duration);                                                                                 // [0x54435d0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void Multicast_DispatchAdrenalineEvents(bool IsHealthy, float HealAmount);                                            // [0x5443940] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/DBDCompetence.Adrenaline.GetExhaustionDuration
	// float GetExhaustionDuration();                                                                                        // [0x5443790] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInRangeChanged(bool inRange);                                                                                  // [0x5443a40] Final|Native|Private 
};
...
public:
	...
	// void Authority_OnPalletPulledUp(FGameplayTag GameplayTag, FGameEventData& GameEventData);                             // [0x5443290] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// void OnSurvivorRemoved(class ACamperPlayer* Survivor);                                                                // [0x5443d40] Final|Native|Protected 
	// Function /Script/DBDCompetence.AnySurvivorHasObjectState.OnSurvivorAdded
	// void OnSurvivorAdded(class ACamperPlayer* Survivor);                                                                  // [0x5443cb0] Final|Native|Protected 
};
...
public:
	...
	// float GetShowAuraTimeAtLevel();                                                                                       // [0x54438b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Babysitter.GetScratchMarkHidingTimeAtLevel
	// float GetScratchMarkHidingTimeAtLevel();                                                                              // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Babysitter.GetHasteEffectAtLevel
	// float GetHasteEffectAtLevel();                                                                                        // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Babysitter.GetCooldownTimeAtLevel
	// float GetCooldownTimeAtLevel();                                                                                       // [0x5443730] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateIsTrue(class UInteractionDefinition* InteractionDefinition);                                               // [0x5443f10] Final|Native|Protected 
	// Function /Script/DBDCompetence.BaseIsPlayerPerformingInteraction.SetInteractionSemantics
	// void SetInteractionSemantics(FGameplayTagContainer& interactionSemantics);                                            // [0x5443dd0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetLingerDuration(float lingerDuration);                                                                         // [0x5443e90] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDCompetence.BaseLingeringStatusEffect.Authority_DeactivateEffect
	// void Authority_DeactivateEffect();                                                                                    // [0x5443020] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDCompetence.BaseLingeringStatusEffect.Authority_ActivateEffect
	// void Authority_ActivateEffect();                                                                                      // [0x5443000] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnStartedGeneratorRepair(FGameplayTag GameplayTag, FGameEventData& GameEventData);                               // [0x5443ba0] Final|Native|Private|HasOutParms 
	// Function /Script/DBDCompetence.BetterTogether.GetRevealDistance
	// float GetRevealDistance();                                                                                            // [0x5443880] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnExitBoonRange();                                                                                               // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/DBDCompetence.BlessedStatusEffect.OnEnterBoonRange
	// void OnEnterBoonRange();                                                                                              // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/DBDCompetence.BlessedStatusEffect.GetBoundTotem
	// class ATotem* GetBoundTotem();                                                                                        // [0x54436d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.BlessedStatusEffect.GetBoonTotemBlessingRange
	// float GetBoonTotemBlessingRange();                                                                                    // [0x54436a0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.BlessedStatusEffect.Authority_OnSurvivorRemovedFromGame
	// void Authority_OnSurvivorRemovedFromGame(class ACamperPlayer* Survivor);                                              // [0x54434c0] Final|Native|Private 
};
...
public:
	...
	// float GetCooldownDurationAtLevel();                                                                                   // [0x5443700] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Authority_OnSurvivorRemoved(class ACamperPlayer* Survivor);                                                      // [0x5443430] Final|Native|Private 
};
...
public:
	...
	// void OnSlasherSet(class ASlasherPlayer* Slasher);                                                                     // [0x5443b10] Final|Native|Private 
	// Function /Script/DBDCompetence.Breakout.OnRep_IsPerkActive
	// void OnRep_IsPerkActive();                                                                                            // [0x5443af0] Final|Native|Private 
	// Function /Script/DBDCompetence.Breakout.GetWiggleEffect
	// float GetWiggleEffect();                                                                                              // [0x5443900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Breakout.GetSurvivorDistanceMax
	// float GetSurvivorDistanceMax();                                                                                       // [0x54438e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Breakout.GetHasteEffectAtLevel
	// float GetHasteEffectAtLevel();                                                                                        // [0x5443820] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Breakout.Authority_OnRangeChanged
	// void Authority_OnRangeChanged(bool inRange);                                                                          // [0x54433a0] Final|Native|Private 
	// Function /Script/DBDCompetence.Breakout.Authority_ImposeWiggleStatusEffect
	// void Authority_ImposeWiggleStatusEffect(class ACamperPlayer* Survivor);                                               // [0x5443040] Final|Native|Private 
};
...
public:
	...
	// float GetPerkDurationAtLevel();                                                                                       // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_BlockedGenerators();                                                                                       // [0x5443ad0] Final|Native|Private 
	// Function /Script/DBDCompetence.CorruptIntervention.Multicast_DispatchBlockedEvent
	// void Multicast_DispatchBlockedEvent();                                                                                // [0x5443a20] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/DBDCompetence.CorruptIntervention.LevelReadyToBlockedGenerators
	// void LevelReadyToBlockedGenerators();                                                                                 // [0x5443920] Final|Native|Private 
	// Function /Script/DBDCompetence.CorruptIntervention.GetGeneratorBlockDuration
	// float GetGeneratorBlockDuration();                                                                                    // [0x54437c0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.CorruptIntervention.Authority_TryActivatePerk
	// void Authority_TryActivatePerk();                                                                                     // [0x5443650] Final|Native|Private 
	// Function /Script/DBDCompetence.CorruptIntervention.Authority_OnLevelReadyToPlay
	// void Authority_OnLevelReadyToPlay();                                                                                  // [0x5443270] Final|Native|Private 
};
...
public:
	...
	// float GetHealPenaltyAtLevel();                                                                                        // [0x5443850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetBlockDurationAtLevel();                                                                                      // [0x5443670] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// float GetKillerRevealDurationAtLevel();                                                                               // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.DarkSense.GetDarkSenseRevealRange
	// float GetDarkSenseRevealRange();                                                                                      // [0x5443760] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.DarkSense.Authority_OnInRangeChanged
	// void Authority_OnInRangeChanged(bool inRange);                                                                        // [0x54431e0] Final|Native|Private 
};
...
public:
	...
	// class UIsPlayerPerformingInteraction* IsPlayerPerformingInteraction(TScriptInterface<Class> ConditionReceiver, FGameplayTagContainer& interactionSemantics); // [0x5448790] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DBDCompetence.DBDConditionFactory.HasTimerElapsedWhileConditionWasTrue
	// class UTimerElapsedCondition* HasTimerElapsedWhileConditionWasTrue(TScriptInterface<Class> ConditionReceiver, class UTimerObject* Timer); // [0x54486a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.DBDConditionFactory.DoesPerkHaveToken
	// class UDoesPerkHaveToken* DoesPerkHaveToken(TScriptInterface<Class> ConditionReceiver, class UPerk* Perk);            // [0x5448350] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnUnhookedTimerEnded();                                                                                          // [0x5449330] Final|Native|Private 
	// Function /Script/DBDCompetence.DecisiveStrike.OnSkillCheck
	// void OnSkillCheck(bool hadInput, bool success, bool Bonus, ESkillCheckCustomType Type, class ADBDPlayer* Player);     // [0x54490a0] Final|Native|Private 
	// Function /Script/DBDCompetence.DecisiveStrike.OnRep_HasBeenAttempted
	// void OnRep_HasBeenAttempted();                                                                                        // [0x5448fe0] Final|Native|Private 
	// Function /Script/DBDCompetence.DecisiveStrike.OnPickUpEnded
	// void OnPickUpEnded(class ADBDPlayer* picker);                                                                         // [0x5448f30] Final|Native|Private 
	// Function /Script/DBDCompetence.DecisiveStrike.OnOwnerPickedUp
	// void OnOwnerPickedUp(class ADBDPlayer* picker);                                                                       // [0x5448b20] Final|Native|Private 
	// Function /Script/DBDCompetence.DecisiveStrike.GetDurationAfterUnhook
	// float GetDurationAfterUnhook();                                                                                       // [0x5443670] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_RevealedGenerators();                                                                                      // [0x5449060] Final|Native|Private 
	// Function /Script/DBDCompetence.DejaVu.LevelReadyToRevealOutlineGenerators
	// void LevelReadyToRevealOutlineGenerators();                                                                           // [0x54488b0] Final|Native|Private 
	// Function /Script/DBDCompetence.DejaVu.GetActionSpeedsAtLevel
	// float GetActionSpeedsAtLevel();                                                                                       // [0x54437c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.DejaVu.Authority_SetNewGeneratorsToReveal
	// void Authority_SetNewGeneratorsToReveal();                                                                            // [0x5448300] Final|Native|Private 
	// Function /Script/DBDCompetence.DejaVu.Authority_OnGeneratorRepaired
	// void Authority_OnGeneratorRepaired(int32_t activatedGeneratorCount);                                                  // [0x5447ec0] Final|Native|Private 
};
...
public:
	...
	// void Authority_OnOwningCamperPickedUp(class ADBDPlayer* picker);                                                      // [0x5448130] Final|Native|Private 
	// Function /Script/DBDCompetence.DelayedHealEffect.Authority_OnOwningCamperHealthChanged
	// void Authority_OnOwningCamperHealthChanged(ECamperDamageState before, ECamperDamageState after);                      // [0x5448060] Final|Native|Private 
	// Function /Script/DBDCompetence.DelayedHealEffect.Authority_OnActivationTimerComplete
	// void Authority_OnActivationTimerComplete();                                                                           // [0x5447ea0] Final|Native|Private 
};
...
public:
	...
	// void OnRep_AuraBlockIsActive();                                                                                       // [0x5448fc0] Final|Native|Private 
	// Function /Script/DBDCompetence.Distortion.OnAuraBlockedCosmetic
	// void OnAuraBlockedCosmetic();                                                                                         // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.Distortion.GetRegainTokenDurationTimer
	// float GetRegainTokenDurationTimer();                                                                                  // [0x5448640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Distortion.GetActivationDurationAtLevel
	// float GetActivationDurationAtLevel();                                                                                 // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Distortion.AuraBlockCanBeActive
	// bool AuraBlockCanBeActive();                                                                                          // [0x5447e50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetPerk(class UPerk* Perk);                                                                                      // [0x5449370] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.DoesPerkHaveToken.OnRep_Perk
	// void OnRep_Perk();                                                                                                    // [0x5449020] Final|Native|Private 
};
...
public:
	...
	// void OnRep_ReplicatedIsTrue();                                                                                        // [0x5449040] Final|Native|Private 
};
...
public:
	...
	// void OnObsessionChanged(class ACamperPlayer* newObsession, class ACamperPlayer* previousObsession);                   // [0x5448a50] Final|Native|Private 
	// Function /Script/DBDCompetence.DyingLight.GetObsessionActionSpeedBonus
	// float GetObsessionActionSpeedBonus();                                                                                 // [0x5448590] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.DyingLight.GetActionSpeedPenaltyPerTokenAtLevel
	// float GetActionSpeedPenaltyPerTokenAtLevel();                                                                         // [0x5448440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetRecoveryProgressionAtLevel();                                                                                // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.FlipFlop.GetMaxWiggleProgressionAtLevel
	// float GetMaxWiggleProgressionAtLevel();                                                                               // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.FlipFlop.Authority_OnPickedUp
	// void Authority_OnPickedUp(class ADBDPlayer* picker);                                                                  // [0x54481c0] Final|Native|Private 
};
...
public:
	...
	// float GetUndetectableAndHasteStatusEffectDurationAtLevel();                                                           // [0x5448670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.FurtiveChase.GetHasteStatusEffectPercent
	// float GetHasteStatusEffectPercent();                                                                                  // [0x54484d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void RemoveCantEscapeFlag();                                                                                          // [0x5449350] Final|Native|Protected 
};
...
public:
	...
	// void OnItemChargeStateChanged(bool IsEmpty);                                                                          // [0x54489c0] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_IsWigglePercentReached();                                                                                  // [0x5449000] Final|Native|Private 
	// Function /Script/DBDCompetence.HasPlayerReachedWiggleFillPercentCondition.Authority_OnOwnerWiggleChargePercentChanged
	// void Authority_OnOwnerWiggleChargePercentChanged(class UChargeableComponent* ChargeableComponent, float PercentCompletionChange, float TotalPercentComplete); // [0x5447f50] Final|Native|Private 
};
...
public:
	...
	// void OnPawnOverlapExit(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x5448dd0] Final|Native|Private 
	// Function /Script/DBDCompetence.HeadOn.OnPawnOverlapEnter
	// void OnPawnOverlapEnter(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x5448bb0] Final|Native|Private|HasOutParms 
	// Function /Script/DBDCompetence.HeadOn.OnHeadOnAnimationComplete
	// void OnHeadOnAnimationComplete();                                                                                     // [0x54489a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.HeadOn.Multicast_TriggerStunOnActor
	// void Multicast_TriggerStunOnActor(class UObject* stunnableInterfaceUObject, class ADBDPlayer* stunner);               // [0x54488d0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/DBDCompetence.HeadOn.GetHideDuration
	// float GetHideDuration();                                                                                              // [0x54437c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.HeadOn.CanApplyHeadOnInteraction
	// bool CanApplyHeadOnInteraction();                                                                                     // [0x5448320] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.HeadOn.Authority_ActivatePerk
	// void Authority_ActivatePerk();                                                                                        // [0x5447e80] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnStoppedHealing(class ADBDPlayer* Instigator, class ADBDPlayer* Target);                                        // [0x5449260] Native|Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.HemorrhageStatusEffect.Authority_OnSurvivorHealed
	// void Authority_OnSurvivorHealed(FCamperHealResult& healResult);                                                       // [0x5448250] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void UpdateCursedStatusViewOnLocalPlayer();                                                                           // [0x544f680] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDCompetence.HexPerk.OnRep_PlayersWhoKnowCurse
	// void OnRep_PlayersWhoKnowCurse();                                                                                     // [0x544f1f0] Final|Native|Private 
	// Function /Script/DBDCompetence.HexPerk.IsCurseRevealedToPlayer
	// bool IsCurseRevealedToPlayer(class ADBDPlayer* Player);                                                               // [0x544ed20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.HexPerk.Authority_SetCurseRevealedToPlayer
	// void Authority_SetCurseRevealedToPlayer(class ADBDPlayer* Player, bool revealed);                                     // [0x544e810] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/DBDCompetence.HexPerk.Authority_RevealCurseToAllSurvivors
	// void Authority_RevealCurseToAllSurvivors(bool revealed);                                                              // [0x544e780] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// float GetRangeFromUnhookedSurvivorNeeded(int32_t PerkLevel);                                                          // [0x54485b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.HexDevourHope.GetMoveSpeedIncrement
	// float GetMoveSpeedIncrement(int32_t PerkLevel);                                                                       // [0x54484f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetExposedDurationAtLevel();                                                                                    // [0x5448470] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_SetShouldActivateTotemOutline();                                                                           // [0x5449080] Final|Native|Private 
	// Function /Script/DBDCompetence.HexNoOneEscapesDeath.GetHasteAtLevel
	// float GetHasteAtLevel();                                                                                              // [0x54484a0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// float GetRegressionModifierByLevel(int32_t PerkLevel);                                                                // [0x544e930] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.HexRuin.Authority_SetupCurseOnAllGenerators
	// void Authority_SetupCurseOnAllGenerators();                                                                           // [0x544e8e0] Final|Native|Private 
};
...
public:
	...
	// float GetSpeedPenaltyPercents(int32_t tierLevel);                                                                     // [0x544e9d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HideVFX(bool Hide);                                                                                              // [0x544ea70] Final|Native|Private|BlueprintCallable 
};
...
public:
	...
	// void SetCurrentEffectLevel(int32_t Level);                                                                            // [0x544f5f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.HighestLevelAndClosestEffectCondition.InitEffectArrays
	// void InitEffectArrays(FName effectIDLevel1, FName effectIDLevel2, FName effectIDLevel3);                              // [0x544ebd0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// float GetHasteEffectAtLevel();                                                                                        // [0x5443850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Server_OnCamperLoudNoise(FGameplayTag GameplayTag, FGameEventData GameEventData);                                // [0x544f4a0] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/DBDCompetence.ImAllEars.GetDurationAtLevel
	// float GetDurationAtLevel();                                                                                           // [0x54437f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.ImAllEars.GetCooldownAtLevel
	// int32_t GetCooldownAtLevel();                                                                                         // [0x544e900] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnEventFired(FGameEventData& GameEventData);                                                                     // [0x66265f0] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void RevealSurvivorLocation(class ACamperPlayer* Target);                                                             // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.InfectiousFright.OnRep_PerkActivationCount
	// void OnRep_PerkActivationCount();                                                                                     // [0x544f1d0] Final|Native|Private 
};
...
public:
	...
	// float GetHideDuration();                                                                                              // [0x5443850] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.InnerStrength.Authority_OnPlayerImmobilizeStateChanged
	// void Authority_OnPlayerImmobilizeStateChanged(EImmobilizedState oldImmobilizeState, EImmobilizedState newImmobilizeState); // [0x544e6b0] Final|Native|Private 
};
...
public:
	...
	// float GetStillnessRequiredAtLevel();                                                                                  // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInRangeChanged(bool inRange, class UProveThyselfEffect* ProveThyselfEffect);                                   // [0x544f010] Final|Native|Private 
};
...
public:
	...
	// void OnStatusEffectAddedOrRemoved(class UStatusEffect* effect, bool Valid);                                           // [0x544f230] Final|Native|Private 
};
...
public:
	...
	// void OnStatusEffectApplicableChanged(class UGameplayModifierContainer* GameplayModifierContainer, bool IsApplicable); // [0x544f3d0] Final|Native|Private 
	// Function /Script/DBDCompetence.IsHighestTierOriginatingPerk.OnStatusEffectAddedOrRemoved
	// void OnStatusEffectAddedOrRemoved(class UStatusEffect* effect, bool Valid);                                           // [0x544f300] Final|Native|Private 
	// Function /Script/DBDCompetence.IsHighestTierOriginatingPerk.OnGameplayModifierContainerInitialized
	// void OnGameplayModifierContainerInitialized();                                                                        // [0x544eff0] Final|Native|Private 
};
...
public:
	...
	// void OnInRangeChanged(bool inRange);                                                                                  // [0x54489c0] Final|Native|Private 
};
...
public:
	...
	// void OnRep_TotemCount();                                                                                              // [0x544f210] Final|Native|Private 
	// Function /Script/DBDCompetence.IsOriginatingPerkBoundToTotems.Init
	// void Init(EComparisonOperation comparisonOperator, int32_t totemCount);                                               // [0x544eb00] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x544f0e0] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_IsLookingTowards(bool IsLookingTowards);                                                                   // [0x54489c0] Final|Native|Private 
	// Function /Script/DBDCompetence.IsPlayerLookingAtKillerCondition.OnPawnControllerChanged
	// void OnPawnControllerChanged(class APawn* Pawn, class AController* Controller);                                       // [0x544f100] Final|Native|Private 
};
...
public:
	...
	// void OnCollectableChargeStateChange(bool Empty);                                                                      // [0x544edc0] Final|Native|Private 
};
...
public:
	...
	// void OnCollectablePickedUp(class ADBDPlayer* Player);                                                                 // [0x544ef60] Final|Native|Private 
	// Function /Script/DBDCompetence.IsPlayerPerformingItemInteraction.OnCollectableDropped
	// void OnCollectableDropped(EItemDropType dropType);                                                                    // [0x544eee0] Final|Native|Private 
	// Function /Script/DBDCompetence.IsPlayerPerformingItemInteraction.OnCollectableChargeStateChange
	// void OnCollectableChargeStateChange(bool Empty);                                                                      // [0x544ee50] Final|Native|Private 
};
...
public:
	...
	// void UpdateIsTrue(class UInteractionDefinition* InteractionDefinition);                                               // [0x544f6a0] Final|Native|Private 
...
public:
	...
	// void RegisterWhenKillerSet(class ASlasherPlayer* killer);                                                             // [0x54549e0] Final|Native|Private 
};
...
public:
	...
	// float GetKillerAuraRevealRangeAtLevel();                                                                              // [0x5448440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetLingerDuration(float lingerDuration);                                                                         // [0x5454a70] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDCompetence.LingeringBlessedStatusEffect.Authority_OnInRangeChanged
	// void Authority_OnInRangeChanged(bool inRange);                                                                        // [0x5454490] Final|Native|Private 
};
...
public:
	...
	// float GetMinActivationTime();                                                                                         // [0x5443760] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.LuckyBreak.GetMaxActivationTimeAtLevel
	// float GetMaxActivationTimeAtLevel();                                                                                  // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.LuckyBreak.GetHealingTimeToActivationTimeRatio
	// float GetHealingTimeToActivationTimeRatio();                                                                          // [0x5448640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.LuckyBreak.Authority_TryActivatePerk
	// void Authority_TryActivatePerk();                                                                                     // [0x54546a0] Final|Native|Private 
	// Function /Script/DBDCompetence.LuckyBreak.Authority_OnDamageStateChanged
	// void Authority_OnDamageStateChanged(ECamperDamageState oldDamageState, ECamperDamageState CurrentDamageState);        // [0x54542f0] Final|Native|Private 
	// Function /Script/DBDCompetence.LuckyBreak.ActivationTimerEnded
	// void ActivationTimerEnded();                                                                                          // [0x5454200] Final|Native|Private 
};
...
public:
	...
	// void Multicast_TriggerEffectAppliedVFX(class ACamperPlayer* Player);                                                  // [0x5454790] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/DBDCompetence.MakeYourChoice.GetMinimumHookedSurvivorDistance
	// float GetMinimumHookedSurvivorDistance();                                                                             // [0x5454720] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.MakeYourChoice.Cosmetic_OnTriggerEffectVFX
	// void Cosmetic_OnTriggerEffectVFX(class ACamperPlayer* Player);                                                        // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// float GetEffectDurationAfterRepairAtLevel();                                                                          // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetFasterDrainPercentageAtLevel();                                                                              // [0x54438b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.MonstrousShrine.Authority_OnSurvivorUnhookedOnScourgeHook
	// void Authority_OnSurvivorUnhookedOnScourgeHook(FGameEventData& GameEventData);                                        // [0x54545f0] Final|Native|Private|HasOutParms 
	// Function /Script/DBDCompetence.MonstrousShrine.Authority_OnSurvivorHookedOnScourgeHook
	// void Authority_OnSurvivorHookedOnScourgeHook(FGameEventData& GameEventData);                                          // [0x5454540] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// float GetMovementSpeedPercentage();                                                                                   // [0x4f65c20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.NoOneLeftBehind.GetMovementSpeedDuration
	// float GetMovementSpeedDuration();                                                                                     // [0x5454750] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.NoOneLeftBehind.GetActionSpeedModifierValueAtLevel
	// float GetActionSpeedModifierValueAtLevel();                                                                           // [0x5443820] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.NoOneLeftBehind.Authority_OnExitGatePoweredApplicableChanged
	// void Authority_OnExitGatePoweredApplicableChanged(class UGameplayModifierContainer* Container, bool Active);          // [0x54543c0] Final|Native|Private 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x54548f0] Final|Native|Protected 
};
...
public:
	...
	// float GetSearchSpeedAtLevel();                                                                                        // [0x5443850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void PlayerExitExitArea();                                                                                            // [0x54549c0] Final|Native|Private 
	// Function /Script/DBDCompetence.PlayerIsInExitArea.PlayerEnterExitArea
	// void PlayerEnterExitArea();                                                                                           // [0x54549a0] Final|Native|Private 
};
...
public:
	...
	// float GetMovementSpeedPercentBuffAtLevel();                                                                           // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.PlayWithYourFood.GetChargeGainedCooldown
	// float GetChargeGainedCooldown();                                                                                      // [0x54546c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.PlayWithYourFood.Authority_OnChaseEnded
	// void Authority_OnChaseEnded(class ADBDPlayer* Player, float chaseTime);                                               // [0x5454220] Final|Native|Private 
};
...
public:
	...
	// float GetActivationTime();                                                                                            // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Multicast_OnPerkActivate();                                                                                      // [0x5443a20] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/DBDCompetence.Premonition.GetPerkFrequencyAtLevel
	// float GetPerkFrequencyAtLevel();                                                                                      // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Premonition.GetPerkEffectRange
	// float GetPerkEffectRange();                                                                                           // [0x5454770] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Premonition.Cosmetic_OnPerkActivate
	// void Cosmetic_OnPerkActivate();                                                                                       // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSurvivorInOwnerRangeChanged(bool inRange);                                                                     // [0x5454910] Final|Native|Private 
};
...
public:
	...
	// void Authority_OnSurvivorRemoved(class ACamperPlayer* Survivor);                                                      // [0x5459890] Final|Native|Protected 
};
...
public:
	...
	// void OnInRangeOfOriginatorChanged(bool inRange, class ACamperPlayer* Survivor);                                       // [0x5454820] Native|Protected     
};
...
public:
	...
	// float GetCooldownDurationSecondsAtLevel();                                                                            // [0x54546f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.QuickAndQuiet.Authority_OnPlayerRushedActionFinished
	// void Authority_OnPlayerRushedActionFinished();                                                                        // [0x5454520] Final|Native|Private 
};
...
public:
	...
	// FLinearColor GetScourgeHooksAuraColour();                                                                             // [0x5459ba0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Saboteur.GetRevealHookDistanceAtLevel
	// float GetRevealHookDistanceAtLevel();                                                                                 // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Saboteur.GetCooldownDurationAtLevel
	// float GetCooldownDurationAtLevel();                                                                                   // [0x5443670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetNumberOfHealStateToHealToActivateAtLevel();                                                                  // [0x54438b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SecondWind.GetDurationOfHealAtLevel
	// float GetDurationOfHealAtLevel();                                                                                     // [0x5443730] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SecondWind.Authority_OnHealProgress
	// void Authority_OnHealProgress(float individualChargeAmount, float totalChargeAmount, class AActor* chargeInstigator, bool wasCoop, float DeltaTime); // [0x5458f30] Final|Native|Private 
};
...
public:
	...
	// void OnRep_InteractionAttacherComponent();                                                                            // [0x5459f90] Final|Native|Private 
};
...
public:
	...
	// void VFXTotemFound();                                                                                                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.SmallGame.SearchForTotems
	// void SearchForTotems();                                                                                               // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.SmallGame.Multicast_TotemFound
	// void Multicast_TotemFound();                                                                                          // [0x5443a20] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/DBDCompetence.SmallGame.GetDetectionConeAngle
	// float GetDetectionConeAngle();                                                                                        // [0x5459a80] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SmallGame.Authority_SetTotemDetected
	// void Authority_SetTotemDetected(bool value);                                                                          // [0x5459920] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void Authority_OnSurvivorAdded(class ACamperPlayer* Survivor);                                                        // [0x5459800] Final|Native|Private 
};
...
public:
	...
	// void Authority_OnSkillCheckResponse(bool success, bool Bonus, class ADBDPlayer* Player, bool TriggerLoudNoise, bool hadInput, ESkillCheckCustomType Type, float ChargeChange); // [0x54595c0] Final|Native|Private 
	// Function /Script/DBDCompetence.Solidarity.Authority_OnHealthChargeApplied
	// void Authority_OnHealthChargeApplied(float individualChargeAmount, float totalChargeAmount, class AActor* chargeInstigator, bool wasCoop, float DeltaTime); // [0x54590e0] Final|Native|Private 
};
...
public:
	...
	// float GetLifetimeOfStatusEffectAtLevel();                                                                             // [0x5459ae0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.SpawningEffectOnGameEventPerk.GetCustomParameterOfStatusEffectAtLevel
	// float GetCustomParameterOfStatusEffectAtLevel();                                                                      // [0x5459a50] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// float GetCooldownDuration();                                                                                          // [0x5454720] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsLookingTowards();                                                                                              // [0x5459f20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SpineChillPerk.IsInRange
	// bool IsInRange();                                                                                                     // [0x5459ef0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SpineChillPerk.HasLineOfSight
	// bool HasLineOfSight();                                                                                                // [0x5459d50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SpineChillPerk.GetRange
	// float GetRange();                                                                                                     // [0x5459b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SpineChillPerk.GetLingerDuration
	// float GetLingerDuration();                                                                                            // [0x5459b10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SpineChillPerk.Authority_OnIsLookingTowardsChanged
	// void Authority_OnIsLookingTowardsChanged(bool IsLookingTowards);                                                      // [0x54593b0] Final|Native|Private 
	// Function /Script/DBDCompetence.SpineChillPerk.Authority_OnIsInLineOfSightChanged
	// void Authority_OnIsInLineOfSightChanged(bool isInLineOfSight);                                                        // [0x5459320] Final|Native|Private 
	// Function /Script/DBDCompetence.SpineChillPerk.Authority_OnInRangeChanged
	// void Authority_OnInRangeChanged(bool inRange);                                                                        // [0x5459290] Final|Native|Private 
};
...
public:
	...
	// float GetSprintDuration();                                                                                            // [0x5443760] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SprintBurst.GetExhaustedDuration
	// float GetExhaustedDuration();                                                                                         // [0x5443670] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.SprintBurst.Authority_OnPerkFlagsChanged
	// void Authority_OnPerkFlagsChanged(FGameplayTag GameplayTag, bool isAdded);                                            // [0x54594d0] Final|Native|Private 
	// Function /Script/DBDCompetence.SprintBurst.Authority_OnIsRunningAndMovingChanged
	// void Authority_OnIsRunningAndMovingChanged(bool isRunningAndMoving);                                                  // [0x5459440] Final|Native|Private 
};
...
public:
	...
	// void Server_ConsumeToken();                                                                                           // [0x5459fb0] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/DBDCompetence.StakeOutPerk.Local_BroadcastConsumeToken
	// void Local_BroadcastConsumeToken();                                                                                   // [0x5459f50] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDCompetence.StakeOutPerk.GetTokenChargeTime
	// float GetTokenChargeTime();                                                                                           // [0x5459cf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.StakeOutPerk.GetMaxTokensAtLevel
	// float GetMaxTokensAtLevel();                                                                                          // [0x5459b40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void InitStatBP(FTunableStat& theStat, TScriptInterface<Class> ModifierProvider);                                     // [0x5459d80] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DBDCompetence.StatsSystemUtilities.GetStatValueBP
	// float GetStatValueBP(FTunableStat& theStat);                                                                          // [0x5459be0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// float GetZoneRadius();                                                                                                // [0x5459d20] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Surge.GetInstantRegressionAtLevel
	// float GetInstantRegressionAtLevel();                                                                                  // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Surge.GetHasCooldown
	// bool GetHasCooldown();                                                                                                // [0x5459ab0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Surge.GetCooldownDurationAtLevel
	// float GetCooldownDurationAtLevel();                                                                                   // [0x54438b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Surge.Client_TriggerEffects
	// void Client_TriggerEffects(TArray<AGenerator*> generators);                                                           // [0x54599b0] Final|Net|Native|Event|Private|NetClient 
};
...
public:
	...
	// void OnRep_NumTokenSoFar();                                                                                           // [0x5459f70] Final|Native|Private 
	// Function /Script/DBDCompetence.TheMettleOfMan.OnRep_CurrentPhase
	// void OnRep_CurrentPhase();                                                                                            // [0x5459f70] Final|Native|Private 
	// Function /Script/DBDCompetence.TheMettleOfMan.GetRevealOutsideRangeAtLevel
	// float GetRevealOutsideRangeAtLevel();                                                                                 // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_BlockedGenerators();                                                                                       // [0x545c340] Final|Native|Private 
	// Function /Script/DBDCompetence.ThrillingTremors.GetDurationAtLevel
	// float GetDurationAtLevel();                                                                                           // [0x54437f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.ThrillingTremors.GetCooldownAtLevel
	// int32_t GetCooldownAtLevel();                                                                                         // [0x544e900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetTriggerThreshold();                                                                                          // [0x545c260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Tinkerer.GetActivationTimeAtLevel
	// float GetActivationTimeAtLevel();                                                                                     // [0x5448670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.Tinkerer.Authority_OnUndetectableGeneratorInterrupt
	// void Authority_OnUndetectableGeneratorInterrupt(class ADBDPlayer* Instigator, class ADBDPlayer* Target);              // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Script/DBDCompetence.Tinkerer.Authority_OnUndetectableAttackSuccessNearActiveGenerator
	// void Authority_OnUndetectableAttackSuccessNearActiveGenerator(class ADBDPlayer* Instigator, class ADBDPlayer* Target); // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Script/DBDCompetence.Tinkerer.Authority_OnLevelReadyToPlay
	// void Authority_OnLevelReadyToPlay();                                                                                  // [0x545c100] Final|Native|Private 
	// Function /Script/DBDCompetence.Tinkerer.Authority_OnGeneratorReachedThreshold
	// void Authority_OnGeneratorReachedThreshold(class AGenerator* Generator);                                              // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Script/DBDCompetence.Tinkerer.Authority_OnGeneratorChargePercentChanged
	// void Authority_OnGeneratorChargePercentChanged(class UChargeableComponent* ChargeableComponent, float PercentCompletionChange, float TotalPercentComplete); // [0x545bff0] Final|Native|Private 
};
...
public:
	...
	// float GetPerkDurationAtLevel();                                                                                       // [0x545c230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.WellMakeIt.GetHealingSpeed
	// float GetHealingSpeed();                                                                                              // [0x5448640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDCompetence.WellMakeIt.Authority_OnUnHook
	// void Authority_OnUnHook(FGameplayTag gameEventType, FGameEventData& GameEventData);                                   // [0x545c120] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnRep_PerkEnabled();                                                                                             // [0x545c360] Final|Native|Private 
};
...
public:
	...
	// void OnWhispersAudio();                                                                                               // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.Whispers.OnRep_SurvivorsInRange
	// void OnRep_SurvivorsInRange();                                                                                        // [0x545c380] Final|Native|Private 
	// Function /Script/DBDCompetence.Whispers.Multicast_FireAudioEvent
	// void Multicast_FireAudioEvent(int32_t survivorsInRange);                                                              // [0x545c290] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
...
public:
	...
	// void RevealSurvivor(class ACamperPlayer* survivorToReveal);                                                           // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/DBDCompetence.YamaokaFamilyCrest.OnRep_AddonActivationCount
	// void OnRep_AddonActivationCount();                                                                                    // [0x545c320] Final|Native|Private 
};
