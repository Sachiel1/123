...
public:
	...
	// FTimespan BinkLoadingMovie_GetTime();                                                                                 // [0x4dccea0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkFunctionLibrary.BinkLoadingMovie_GetDuration
	// FTimespan BinkLoadingMovie_GetDuration();                                                                             // [0x4dcce60] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkFunctionLibrary.Bink_DrawOverlays
	// void Bink_DrawOverlays();                                                                                             // [0x4dccee0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool SupportsSeeking();                                                                                               // [0x4d6f890] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.SupportsScrubbing
	// bool SupportsScrubbing();                                                                                             // [0x4d6f890] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.SupportsRate
	// bool SupportsRate(float Rate, bool Unthinned);                                                                        // [0x4dcd7e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Stop
	// void Stop();                                                                                                          // [0x4dcd7c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.SetVolume
	// void SetVolume(float Rate);                                                                                           // [0x4dcd740] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.SetRate
	// bool SetRate(float Rate);                                                                                             // [0x4dcd6b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.SetLooping
	// bool SetLooping(bool InLooping);                                                                                      // [0x4dcd580] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Seek
	// bool Seek(FTimespan& InTime);                                                                                         // [0x4dcd4e0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Rewind
	// bool Rewind();                                                                                                        // [0x4dcd4b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Play
	// bool Play();                                                                                                          // [0x4dcd480] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Pause
	// bool Pause();                                                                                                         // [0x4dcd450] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.OpenUrl
	// bool OpenUrl(FString NewUrl);                                                                                         // [0x4dcd3a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsStopped
	// bool IsStopped();                                                                                                     // [0x4dcd370] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsSeeking
	// bool IsSeeking();                                                                                                     // [0x4dcd340] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsPlaying
	// bool IsPlaying();                                                                                                     // [0x4dcd310] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsPaused
	// bool IsPaused();                                                                                                      // [0x4dcd2e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsLooping
	// bool IsLooping();                                                                                                     // [0x4dcd2b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.IsInitialized
	// bool IsInitialized();                                                                                                 // [0x4dcd280] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.GetUrl
	// FString GetUrl();                                                                                                     // [0x4dcd240] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.GetTime
	// FTimespan GetTime();                                                                                                  // [0x4dcd200] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.GetRate
	// float GetRate();                                                                                                      // [0x4dcd1d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.GetDuration
	// FTimespan GetDuration();                                                                                              // [0x4dcd190] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.Draw
	// void Draw(class UTexture* Texture, bool tonemap, int32_t out_nits, float alpha, bool srgb_decode, bool hdr);          // [0x4dccfa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.CloseUrl
	// void CloseUrl();                                                                                                      // [0x4dccf80] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.CanPlay
	// bool CanPlay();                                                                                                       // [0x4dccf30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BinkMediaPlayer.BinkMediaPlayer.CanPause
	// bool CanPause();                                                                                                      // [0x4dccf00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetMediaPlayer(class UBinkMediaPlayer* InMediaPlayer);                                                           // [0x4dcd620] Final|Native|Public|BlueprintCallable 
	// Function /Script/BinkMediaPlayer.BinkMediaTexture.Clear
	// void Clear();                                                                                                         // [0x4dccf60] Final|Native|Public|BlueprintCallable 
};
