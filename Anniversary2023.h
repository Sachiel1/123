...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x51dc330] Final|Native|Private 
};
...
public:
	...
	// void Multicast_BloodlustExpose(class ADBDPlayer* Player, class ACamperPlayer* Target);                                // [0x51dca60] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/Anniversary2023.BloodlustExposeInteraction.Cosmetic_BloodlustExpose
	// void Cosmetic_BloodlustExpose(class ADBDPlayer* Player, class ACamperPlayer* Target);                                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnLocallyObservedChanged();                                                                                      // [0x51dd060] Final|Native|Private 
};
...
public:
	...
	// void OnRep_InvitationChargesInt();                                                                                    // [0x51de090] Final|Native|Protected 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.OnRep_CooldownTimer
	// void OnRep_CooldownTimer();                                                                                           // [0x51de070] Final|Native|Protected 
	...
	// void Multicast_CosmeticOnInvitationInteractionActivate(class ADBDPlayer* Player, class AActor* Target);               // [0x51ddf80] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.Cosmetic_SetVFXParticlesVisibility
	// void Cosmetic_SetVFXParticlesVisibility(bool IsVisible);                                                              // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.Cosmetic_OnPlayerInChaseStateChanged
	// void Cosmetic_OnPlayerInChaseStateChanged(bool inChase);                                                              // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.Cosmetic_OnInvitationInteractionReady
	// void Cosmetic_OnInvitationInteractionReady(bool IsReady);                                                             // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.Cosmetic_OnInvitationInteractionActivate
	// void Cosmetic_OnInvitationInteractionActivate(class ADBDPlayer* abilityCaster, class AActor* Target);                 // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Anniversary2023.InvitationPlayerComponent.Cosmetic_OnInvitationChargesIntChanged
	// void Cosmetic_OnInvitationChargesIntChanged(int32_t invitationCharge);                                                // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRep_NegateStunInteraction(class UKillerNegateStunInteraction* prevNegateStunInteraction);                      // [0x51dd600] Final|Native|Protected 
	// Function /Script/Anniversary2023.InvitationKillerComponent.Cosmetic_SetVignetteVisibility
	// void Cosmetic_SetVignetteVisibility(bool IsVisible);                                                                  // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/Anniversary2023.InvitationKillerComponent.Cosmetic_ActivateVFXOnKillerStunned
	// void Cosmetic_ActivateVFXOnKillerStunned();                                                                           // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRep_TargetGameObject(class AActor* previousTarget);                                                            // [0x51de800] Final|Native|Private 
	// Function /Script/Anniversary2023.InvitationTargetComponent.Cosmetic_OnTargetObjectChanged
	// void Cosmetic_OnTargetObjectChanged(class AActor* Target, class AActor* lastTarget);                                  // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRep_StatusEffect(class UStatusEffect* previousStatusEffect);                                                   // [0x51dec20] Final|Native|Private 
	// Function /Script/Anniversary2023.KillerNegateStunInteraction.Cosmetic_OnInteractionUpdateStart
	// void Cosmetic_OnInteractionUpdateStart(class ADBDPlayer* interactingPlayer, class AInteractable* Interactable);       // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void Multicast_RemoteDestroy(class ADBDPlayer* Player, class AInteractable* Interactable);                            // [0x51dca60] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/Anniversary2023.RemoteDestroyInteraction.ExplodeInteractable
	// void ExplodeInteractable(class ADBDPlayer* Player, class AInteractable* Interactable);                                // [0x51def40] Final|Native|Protected|Const 
	// Function /Script/Anniversary2023.RemoteDestroyInteraction.Cosmetic_OnRemoteDestroy
	// void Cosmetic_OnRemoteDestroy(class ADBDPlayer* interactingPlayer, class AInteractable* Interactable);                // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void Multicast_OnWindowBlockBegin(class ADBDPlayer* abilityCaster, class AWindow* Window);                            // [0x51dca60] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/Anniversary2023.ReverseBamboozleInteractionDefinition.Cosmetic_OnWindowBlockBegin
	// void Cosmetic_OnWindowBlockBegin(class ADBDPlayer* abilityCaster, class AWindow* Window, float Duration);             // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetIndicatorOutlineVisibility(bool activated);                                                                   // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Script/Anniversary2023.SpawnedPalletTracker.OnRep_TrackedPallet
	// void OnRep_TrackedPallet();                                                                                           // [0x51dfb50] Final|Native|Private 
};
