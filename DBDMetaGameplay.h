...
public:
	...
	// void OnChaseStart(class ADBDPlayer* chasedPlayer);                                                                    // [0x54f7140] Final|Native|Public  
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x54f7400] Final|Native|Private 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x54f7750] Final|Native|Public  
};
...
public:
	...
	// void OnChaseStartEvent(class ADBDPlayer* chasedPlayer);                                                               // [0x54f7ba0] Final|Native|Public  
};
...
public:
	...
	// void OnIntroCompleted();                                                                                              // [0x54f7f50] Final|Native|Private 
};
