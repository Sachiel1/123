...
public:
	...
	// bool HasBeenNotified(FName AnimNotify);                                                                               // [0x52f4f10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x52f7910] Final|Native|Protected 
	// Function /Script/DBDAnimation.PlayerAnimInstance.OnIntroCompleted
	// void OnIntroCompleted();                                                                                              // [0x52f78f0] Native|Protected     
	// Function /Script/DBDAnimation.PlayerAnimInstance.GetOwningPlayer
	// class ADBDPlayer* GetOwningPlayer();                                                                                  // [0x52f7590] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsPlayingMontageByName(FName MontageID);                                                                         // [0x52f4fc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.BaseSurvivorAnimInstance.GetOwningSurvivor
	// class ACamperPlayer* GetOwningSurvivor();                                                                             // [0x52f4ee0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ChangeMode(EArmIkMode newMode);                                                                                  // [0x52f4dd0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class ASlasherPlayer* GetOwningKiller();                                                                              // [0x52f4e80] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.BaseKillerAnimInstance.DBD_ForceAnimPOV
	// void DBD_ForceAnimPOV(int32_t animPOV);                                                                               // [0x5235570] Final|Exec|Native|Private 
};
...
public:
	...
	// void OnCustomizationChanged(TArray<FName>& customizationArray);                                                       // [0x66265f0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/DBDAnimation.BaseMenuAnimInstance.GetOwningMenuPlayer
	// class ADBDMenuPlayer* GetOwningMenuPlayer();                                                                          // [0x52f4eb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.BaseMenuAnimInstance.GetCurrentMenu
	// EGameFlowStep GetCurrentMenu();                                                                                       // [0x52f4e50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnSearchedChanged(bool searched);                                                                                // [0x52f51f0] Final|Native|Private 
	// Function /Script/DBDAnimation.ChestAnimInstance.OnBeingPriedOpenStopped
	// void OnBeingPriedOpenStopped();                                                                                       // [0x52f5100] Final|Native|Private 
	// Function /Script/DBDAnimation.ChestAnimInstance.OnBeingPriedOpenStarted
	// void OnBeingPriedOpenStarted(class ADBDPlayer* Player);                                                               // [0x52f5070] Final|Native|Private 
};
...
public:
	...
	// void SetSkillCheckSuccess(bool success);                                                                              // [0x52f52a0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ResetHealerSkillCheckFailed();                                                                                   // [0x52f5280] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DBDAnimation.HealSurvivorSubAnimInstance.OnHealerSkillCheckResponseAesthetic
	// void OnHealerSkillCheckResponseAesthetic(bool success, class ADBDPlayer* healer);                                     // [0x52f5120] Final|Native|Protected 
};
...
public:
	...
	// FName GetWeaponCustomizationId();                                                                                     // [0x52f75c0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsLookAtAllowed();                                                                                               // [0x52f7600] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/DBDAnimation.LookAtKillerSubAnimInstance.GetBlendDuration
	// float GetBlendDuration();                                                                                             // [0x52f7550] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void OnChaseStarted(class ADBDPlayer* Target);                                                                        // [0x52f7860] Final|Native|Private 
	// Function /Script/DBDAnimation.LookAtTargetKillerSubAnimInstance.OnChaseEnded
	// void OnChaseEnded(class ADBDPlayer* Target, float chaseTime);                                                         // [0x52f7790] Final|Native|Private 
};
...
public:
	...
	// void OnBeingPulledUpStopped();                                                                                        // [0x52f7770] Final|Native|Private 
	// Function /Script/DBDAnimation.PalletAnimInstance.OnBeingPulledUpStarted
	// void OnBeingPulledUpStarted(class ADBDPlayer* Player);                                                                // [0x52f76e0] Final|Native|Private 
	// Function /Script/DBDAnimation.PalletAnimInstance.OnBeingDestroyedStopped
	// void OnBeingDestroyedStopped();                                                                                       // [0x52f76c0] Final|Native|Private 
	// Function /Script/DBDAnimation.PalletAnimInstance.OnBeingDestroyedStarted
	// void OnBeingDestroyedStarted(class ADBDPlayer* Player);                                                               // [0x52f7630] Final|Native|Private 
};
...
public:
	...
	// void ResetScreamTrigger();                                                                                            // [0x52f9d30] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void ResetSkillCheckFailed();                                                                                         // [0x4d8c410] Native|Public|BlueprintCallable 
	// Function /Script/DBDAnimation.SkillCheckFailureTracker.OnSkillCheckFailed
	// void OnSkillCheckFailed(FGameplayTag gameEventType, FGameEventData& GameEventData);                                   // [0x52f9c00] Native|Protected|HasOutParms 
};
...
public:
	...
	// void SetAudioRummageAkEvent(FName distance);                                                                          // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/DBDAnimation.SurvivorAnimInstance.OnInfectiousFrightScream
	// void OnInfectiousFrightScream();                                                                                      // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/DBDAnimation.SurvivorAnimInstance.AddAudioRepairRateRadius
	// void AddAudioRepairRateRadius(int32_t distance);                                                                      // [0x66265f0] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ResetReappearTimer();                                                                                            // [0x52f9d10] Final|Native|Private|BlueprintCallable 
	// Function /Script/DBDAnimation.WakerObjectAnimInstance.OnReappear
	// void OnReappear();                                                                                                    // [0x66265f0] Event|Protected|BlueprintEvent 
	// Function /Script/DBDAnimation.WakerObjectAnimInstance.GetWakerObjectStarted
	// bool GetWakerObjectStarted();                                                                                         // [0x52f9bd0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.WakerObjectAnimInstance.GetWakerObjectChargeComplete
	// bool GetWakerObjectChargeComplete();                                                                                  // [0x52f9ba0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.WakerObjectAnimInstance.GetWakerObjectCharge
	// float GetWakerObjectCharge();                                                                                         // [0x52f9b70] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDAnimation.WakerObjectAnimInstance.GetWakerObject
	// class AWakerObject* GetWakerObject();                                                                                 // [0x52f9b40] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
};
