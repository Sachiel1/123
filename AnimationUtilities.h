...
public:
	...
	// void Wakeup();                                                                                                        // [0x8a6f1b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationUtilities.SleepingAnimInstance.SetNeverIdle
	// void SetNeverIdle(bool neverIdle);                                                                                    // [0x8a6f120] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationUtilities.SleepingAnimInstance.OnMontageStart
	// void OnMontageStart(class UAnimMontage* Montage);                                                                     // [0x8a6f090] Final|Native|Public  
};
...
public:
	...
	// void InitSkinnedMeshComponent(class USkinnedMeshComponent* Mesh);                                                     // [0x8a6da70] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationUtilities.BaseGroundDetectorComponent.GetGroundPosition
	// FVector GetGroundPosition(FVector targetPos, FVector extraOffset);                                                    // [0x8a6d970] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool HandleAnimNotify(class AActor* Player, FName& NotifyName);                                                       // [0x8a6ccb0] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// class UAnimInstance* GetSubAnimInstance(class UAnimInstance* Root, class UClass* Type);                               // [0x8a6d200] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationUtilities.AnimInstanceExt.GetRootSkeletalMeshComponent
	// class USkeletalMeshComponent* GetRootSkeletalMeshComponent(class UAnimInstance* AnimInstance);                        // [0x8a6d170] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationUtilities.AnimInstanceExt.GetOwningCharacterSkeletalMeshComponent
	// class USkeletalMeshComponent* GetOwningCharacterSkeletalMeshComponent(class UAnimInstance* AnimInstance);             // [0x8a6d0e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationUtilities.AnimInstanceExt.GetOwningCharacter
	// class ACharacter* GetOwningCharacter(class UAnimInstance* AnimInstance);                                              // [0x8a6d050] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationUtilities.AnimInstanceExt.GetOwningActor
	// class AActor* GetOwningActor(class UAnimInstance* AnimInstance);                                                      // [0x8a6cfc0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// FVector GetLocalVelocity(FName BoneSocketName);                                                                       // [0x8a6dc70] Final|BlueprintCosmetic|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Stop();                                                                                                          // [0x8a6eaa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationUtilities.MoveComponentToComponent.Start
	// void Start(class USceneComponent* componentToMove, class USceneComponent* Target, float Duration);                    // [0x8a6e980] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetMasterMesh(class USkeletalMeshComponent* masterMesh);                                                         // [0x8a6edf0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationUtilities.SlaveAnimInstance.GetMasterMesh
	// class USkeletalMeshComponent* GetMasterMesh();                                                                        // [0x8a6edc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
