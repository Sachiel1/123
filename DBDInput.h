...
public:
	...
	// void RemovePresenterRootWidget(class UUserWidget* presenterRootWidget);                                               // [0x8a7cd00] Final|Native|Public|BlueprintCallable 
	// Function /Script/DBDInput.DBDInputManager.AddPresenterRootWidget
	// void AddPresenterRootWidget(class UUserWidget* presenterRootWidget);                                                  // [0x8a7cc70] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void HandleKeyUpEvent(FKeyEvent& InKeyEvent);                                                                         // [0x8a7d7e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/DBDInput.InteractiveWidgetInterface.HandleKeyHoldEvent
	// void HandleKeyHoldEvent(FKeyEvent& InKeyEvent);                                                                       // [0x8a7d6e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/DBDInput.InteractiveWidgetInterface.HandleKeyDownEvent
	// void HandleKeyDownEvent(FKeyEvent& InKeyEvent);                                                                       // [0x8a7d5e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/DBDInput.InteractiveWidgetInterface.HandleAnalogInputEvent
	// void HandleAnalogInputEvent(FAnalogInputEvent& InAnalogInputEvent);                                                   // [0x8a7d4c0] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// bool ShouldUseAtlantaControls(class UObject* WorldContextObject);                                                     // [0x8a7e0c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DBDInput.UIInputUtilities.IsInputKeyControlModePairValid
	// bool IsInputKeyControlModePairValid(FKey InputKey, EControlMode controlMode);                                         // [0x8a7df80] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDInput.UIInputUtilities.GetKeyFromUIAction
	// FKey GetKeyFromUIAction(EUIActionType ActionType, bool isUsingGamepad);                                               // [0x8a7de20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDInput.UIInputUtilities.AreGamepadButtonsXOSwitched
	// bool AreGamepadButtonsXOSwitched();                                                                                   // [0x8a7ddf0] Final|Native|Static|Public|BlueprintCallable 
};
