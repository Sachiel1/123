...
public:
	...
	// void SelectTracks();                                                                                                  // [0x507e910] Final|Native|Public  
	// Function /Script/DBDProceduralCamera.ProceduralCameraRaD.PlayCinematic
	// void PlayCinematic();                                                                                                 // [0x507e8f0] Final|Native|Private 
	// Function /Script/DBDProceduralCamera.ProceduralCameraRaD.OnCameraTransition
	// void OnCameraTransition(float TransitionDuration, float BeginAt);                                                     // [0x66265f0] Event|Public|BlueprintEvent 
	// Function /Script/DBDProceduralCamera.ProceduralCameraRaD.ComputeTrackObstructionScore
	// void ComputeTrackObstructionScore(FCameraShot& CameraShot);                                                           // [0x507e840] Final|Native|Private|HasOutParms 
	// Function /Script/DBDProceduralCamera.ProceduralCameraRaD.BeginCinematic
	// void BeginCinematic();                                                                                                // [0x507e820] Final|Native|Public  
};
