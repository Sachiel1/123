...
public:
	...
	// void IncrementHookSpawned();                                                                                          // [0x52bfa40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RecordClosetSearchSuccess(class ASlasherPlayer* killer);                                                         // [0x52bfae0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.ClosetAnalytics.RecordClosetSearchFail
	// void RecordClosetSearchFail(class ASlasherPlayer* killer);                                                            // [0x52bfa60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.ClosetAnalytics.IncrementClosetEnter
	// void IncrementClosetEnter(class ACamperPlayer* Survivor);                                                             // [0x52bf9c0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SendTinkererUndetectableInterruptAnalytics(class ADBDPlayer* interruptedPlayer, class ADBDPlayer* Slasher);      // [0x52cdb60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendTinkererUndetectableHitNearGeneratorAnalytics
	// void SendTinkererUndetectableHitNearGeneratorAnalytics(class ADBDPlayer* hitPlayer, class ADBDPlayer* Slasher);       // [0x52cdaa0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendLightbornAuraRevealedAnalytics
	// void SendLightbornAuraRevealedAnalytics(class ADBDPlayer* revealedPlayer, class ADBDPlayer* Slasher);                 // [0x52cd9e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendKnockoutSurvivorFoundAnalytics
	// void SendKnockoutSurvivorFoundAnalytics(class ADBDPlayer* findingSurvivor, class ADBDPlayer* foundSurvivor);          // [0x52cd920] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendFranklinsHitSurvivorNearDroppedItemAnalytics
	// void SendFranklinsHitSurvivorNearDroppedItemAnalytics(class ADBDPlayer* hitSurvivor, class ADBDPlayer* Slasher);      // [0x52cd860] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PerkAnalyticsLibrary.SendFranklinsConsumeItemAnalytics
	// void SendFranklinsConsumeItemAnalytics(class ADBDPlayer* previousOwner);                                              // [0x52cd7e0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RecordRBTSearch(class ACamperPlayer* searchingPlayer, bool success);                                             // [0x52cd720] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.OnRBTAttached_Analytics
	// void OnRBTAttached_Analytics(class ASlasherPlayer* attacher, class ACamperPlayer* attachee);                          // [0x52cd660] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.IncrementRBTTimerActived
	// void IncrementRBTTimerActived(class ACamperPlayer* attachedPlayer);                                                   // [0x52cd5e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PigAnalytics.IncrementRBTKilledCount
	// void IncrementRBTKilledCount(class ACamperPlayer* playerKilled, bool killedByExecutionZone);                          // [0x52cd520] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void IncrementPalletStun(class ACamperPlayer* Survivor);                                                              // [0x52cd4a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletSpawned
	// void IncrementPalletSpawned(class AActor* Actor);                                                                     // [0x52cd420] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletDrop
	// void IncrementPalletDrop(class ACamperPlayer* Survivor);                                                              // [0x52cd3a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.PulldownAnalytics.IncrementPalletDestroy
	// void IncrementPalletDestroy(class ASlasherPlayer* killer);                                                            // [0x52cd320] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RecordHealSuccess(class ACamperPlayer* Survivor);                                                                // [0x52d1100] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.SurvivorInteractionAnalytics.RecordHatchEscape
	// void RecordHatchEscape(class ACamperPlayer* Survivor);                                                                // [0x52d1080] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DBDAnalytics.SurvivorInteractionAnalytics.IncrementHealCount
	// void IncrementHealCount(class ACamperPlayer* Survivor);                                                               // [0x52d1000] Final|Native|Static|Public|BlueprintCallable 
};
