...
public:
	...
	// class UTexture* ReloadTexture(class UTexture* InTexture, FString InSourceName);                                       // [0x45d05a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/BeUtil.BeMaterialEditorHelper.EditMaterialConstant
	// void EditMaterialConstant(class UMaterialInstanceConstant* InMaterialInstance, TArray<FBeMaterialScalar> InScalars, TArray<FBeMaterialVector> InVectors, TArray<FBeMaterialTexture> InTextures); // [0x45d0370] Final|Native|Static|Public|BlueprintCallable 
};
