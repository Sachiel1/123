...
public:
	...
	// class UWorld* GetWorldFromContext(class UObject* WorldContextObject);                                                 // [0x880f940] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/CoreUtilities.CoreUtilities.GetRandomValuesFromArray
	// TArray<int32_t> GetRandomValuesFromArray(TArray<int32_t>& Values, int32_t numberOfDesiredValues);                     // [0x880f800] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CoreUtilities.CoreUtilities.GetGlobalWorld
	// class UWorld* GetGlobalWorld();                                                                                       // [0x880f7d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/CoreUtilities.CoreUtilities.GetGameInstance
	// class UGameInstance* GetGameInstance(class UObject* WorldContextObject);                                              // [0x880f740] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void CopyProperties(class UActorComponent* Dest, class UActorComponent* Origin, bool copyTransform, TArray<FName> propertiesToExclude); // [0x880fe30] Final|Native|Static|Public|BlueprintCallable 
};
