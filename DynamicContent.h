...
public:
	...
	// void OnDownloadSucceeded(class UTexture2DDynamic* textureDownloaded);                                                 // [0x8af4980] Final|Native|Private 
	// Function /Script/DynamicContent.DownloadingTextureTask.OnDownloadFailed
	// void OnDownloadFailed(class UTexture2DDynamic* textureDownloaded);                                                    // [0x8af48f0] Final|Native|Private 
};
...
public:
	...
	// void OnTextureDownloadComplete(class UDownloadingTextureTask* taskCompleted);                                         // [0x8af4b70] Final|Native|Private 
};
...
public:
	...
	// void OnDownloadingTaskComplete(class UDownloadMultiTextureTask* completeTask);                                        // [0x8af4ee0] Final|Native|Private 
};
