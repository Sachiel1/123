...
public:
	...
	// void OnMinigameStart(TArray<EDirectionalInputKey> Sequence, int32_t currentIndex);                                    // [0x53d4330] Final|Native|Private 
	// Function /Script/DBDBots.AISkill_DirectionalMinigame.OnMinigameEnd
	// void OnMinigameEnd(EDirectionalMinigameResult Result);                                                                // [0x53d42b0] Final|Native|Private 
};
...
public:
	...
	// void OnPawnBump(class AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit);           // [0x53e3b50] Final|Native|Private|HasOutParms|HasDefaults 
	// Function /Script/DBDBots.DBDAIBTController.Authority_FinishedPlaying
	// void Authority_FinishedPlaying();                                                                                     // [0x53e3b30] Final|Native|Private 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x53e7d90] Final|Native|Private 
};
...
public:
	...
	// void OnUniqueGameplayEvent(EDBDScoreTypes EventType, float Amount, class AActor* Instigator, class AActor* Target);   // [0x53e7ff0] Final|Native|Private 
	// Function /Script/DBDBots.DBDAIStateComponent.OnStartAimingEventDispatched
	// void OnStartAimingEventDispatched(FGameplayTag gameEventType, FGameEventData& GameEventData);                         // [0x53e7ee0] Final|Native|Private|HasOutParms 
	// Function /Script/DBDBots.DBDAIStateComponent.OnSpecialAttackEventDispatched
	// void OnSpecialAttackEventDispatched(FGameplayTag gameEventType, FGameEventData& GameEventData);                       // [0x53e7dd0] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnLevelReadyToPlay();                                                                                            // [0x53e7db0] Final|Native|Private 
};
...
public:
	...
	// void OnSmartLinkReachedCallback(class AActor* MovingActor, FVector& DestinationPoint);                                // [0x53ebb30] Final|Native|Private|HasOutParms|HasDefaults 
	// Function /Script/DBDBots.NavLinkProxy_Base.AutoAdjustSmartLinkPoints
	// void AutoAdjustSmartLinkPoints();                                                                                     // [0x53ebaf0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnDisplayDebugInfo();                                                                                            // [0x53ebb10] Final|Native|Private 
};
