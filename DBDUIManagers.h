...
public:
	...
	// bool GetLargeTextEnabled();                                                                                           // [0x4cbd540] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UMaterialInterface* GetTooltipRarityMaterial(EItemRarity Rarity);                                               // [0x4cbd7e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIDataManager.GetTooltipEventHeader
	// class UTexture2D* GetTooltipEventHeader(FString EventBannerLabel);                                                    // [0x4cbd6e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIDataManager.GetLoadoutPartRarityMaterial
	// class UMaterialInterface* GetLoadoutPartRarityMaterial(EItemRarity Rarity);                                           // [0x4cbd560] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIDataManager.GetCustomizationRarityMaterial
	// class UMaterialInterface* GetCustomizationRarityMaterial(EItemRarity Rarity);                                         // [0x4cbd450] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIDataManager.GetCurrencyIcon
	// TWeakObjectPtr<UTexture2D*> GetCurrencyIcon(ECurrencyType CurrencyType);                                              // [0x4cbd380] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIDataManager.GetAlertRewardEventBackground
	// class UTexture2D* GetAlertRewardEventBackground(FString EventThemeLabel);                                             // [0x4cbd280] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// float GetSkillCheckScaleFactor();                                                                                     // [0x4cbd6b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIScaleManager.GetScaleFactor
	// float GetScaleFactor(EScaleType Type);                                                                                // [0x4cbd620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIScaleManager.GetMenuScaleFactor
	// float GetMenuScaleFactor();                                                                                           // [0x4cbd5f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIScaleManager.GetHudScaleFactor
	// float GetHudScaleFactor();                                                                                            // [0x4cbd510] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DBDUIManagers.UIScaleManager.GetDPIScaleCurveRatio
	// EDPIScaleCurveRatio GetDPIScaleCurveRatio();                                                                          // [0x4cbd4e0] Final|Native|Public|BlueprintCallable 
};
