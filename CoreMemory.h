...
public:
	...
	// void OnRep_CoreMemoryPortal();                                                                                        // [0x5256ef0] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryController.Authority_OnCharacterAdded
	// void Authority_OnCharacterAdded(class ADBDPlayer* Player);                                                            // [0x5256620] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryController.Authority_CreatePlayerSpecificController
	// void Authority_CreatePlayerSpecificController(class ADBDPlayer* Player);                                              // [0x5256590] Final|Native|Private 
};
...
public:
	...
	// void OnCollectZoneEntered(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x5256b50] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void Authority_OnTriggerZoneExited(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x52568d0] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryDefaultTriggerBehaviour.Authority_OnTriggerZoneEntered
	// void Authority_OnTriggerZoneEntered(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x52566b0] Final|Native|Private|HasOutParms 
	// Function /Script/CoreMemory.CoreMemoryDefaultTriggerBehaviour.Authority_CheckLineOfSight
	// void Authority_CheckLineOfSight(class ACoreMemoryFragment* fragment);                                                 // [0x5256500] Final|Native|Private 
};
...
public:
	...
	// void OnRep_SpawnRotation(FRotator& Rotation);                                                                         // [0x5256fc0] Final|Native|Private|HasOutParms|HasDefaults 
	// Function /Script/CoreMemory.CoreMemoryFragment.OnRep_SpawnLocation
	// void OnRep_SpawnLocation(FVector& Location);                                                                          // [0x5256f30] Final|Native|Private|HasOutParms|HasDefaults 
};
...
public:
	...
	// void Server_OnFragmentCollected();                                                                                    // [0x522fee0] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnRep_WasTriggered
	// void OnRep_WasTriggered();                                                                                            // [0x5257070] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnRep_WasCollected
	// void OnRep_WasCollected();                                                                                            // [0x5257050] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnRep_OwningPlayer
	// void OnRep_OwningPlayer();                                                                                            // [0x5256ed0] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnRep_IsDespawned
	// void OnRep_IsDespawned();                                                                                             // [0x5256f10] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnRep_Controller
	// void OnRep_Controller();                                                                                              // [0x5256ed0] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.OnLocallyObservedChanged
	// void OnLocallyObservedChanged(bool IsLocallyObserved);                                                                // [0x5256e00] Final|Native|Private 
	// Function /Script/CoreMemory.CoreMemoryFragmentComponent.Multicast_FragmentDespawnCountdown
	// void Multicast_FragmentDespawnCountdown(float floatVal);                                                              // [0x5256ac0] Net|NetReliableNative|Event|NetMulticast|Public|Const 
};
...
public:
	...
	// void OnInteractionStarted(class ADBDPlayer* Player);                                                                  // [0x5256d70] Final|Native|Private 
};
...
public:
	...
	// TArray<ADBDPlayer*> GetPlayersWithActivePortal();                                                                     // [0x5256a30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Cosmetic_Scream(class ACamperPlayer* camper);                                                                    // [0x66265f0] BlueprintCosmetic|Event|Protected|BlueprintEvent|Const 
};
...
public:
	...
	// void Authority_AddSpawnedStatusEffect(class UStatusEffect* StatusEffect, class ACoreMemoryChallengePlayerSpecificController* PlayerController); // [0x5258010] Final|Native|Private 
};
