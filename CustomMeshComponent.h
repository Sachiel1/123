...
public:
	...
	// bool SetCustomMeshTriangles(TArray<FCustomMeshTriangle>& Triangles);                                                  // [0x5155430] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CustomMeshComponent.CustomMeshComponent.ClearCustomMeshTriangles
	// void ClearCustomMeshTriangles();                                                                                      // [0x5155410] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomMeshComponent.CustomMeshComponent.AddCustomMeshTriangles
	// void AddCustomMeshTriangles(TArray<FCustomMeshTriangle>& Triangles);                                                  // [0x5155360] Final|Native|Public|HasOutParms|BlueprintCallable 
};
