...
public:
	...
	// void BP_DestroyComponent(class UActorComponent* componentToDestroy);                                                  // [0x5259230] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UBoneSocketLocalVelocityEvaluator* AddBoneSocketLocalVelocityEvaluatorToAccessory(class UAccessory* Accessory, TArray<FName>& trackedBoneSocketNames); // [0x5259420] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
